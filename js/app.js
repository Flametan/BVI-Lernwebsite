...
const KF_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:2,nr:'Frage 2',punkte:5,cat:'BSC / QM',
    ...
    {id:4,nr:'Frage 4',punkte:5,cat:'Bedarfsplanung',
    ...
    {id:5,nr:'Frage 5',punkte:5,cat:'Vergabe',
    ...
    {id:6,nr:'Frage 6',punkte:5,cat:'Bedarfsplanung',
    ...
    {id:8,nr:'Frage 8',punkte:5,cat:'Rechnungswesen',
    ...
    {id:10,nr:'Frage 10',punkte:5,cat:'Weg der Ansatzermittlung (Haushalt)',
    ...
    {id:11,nr:'Frage 11',punkte:5,cat:'VWL',
    ...
    {id:12,nr:'Frage 12',punkte:5,cat:'VWL',
...
const KLAUSUR_HUB = (function(){
  ...
  return {
    render:function(){
      ...
      if(kf) kf.textContent=fmt(getInfo('bvi_kf_scores',12,60));
