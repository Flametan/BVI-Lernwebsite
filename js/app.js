...
const FLASHCARD_DATA = [
  ...
  {id:'h85',cat:'FeuAK · PM',q:'Welche 3 Rationalitäten der Entscheidung werden in der Entscheidungstheorie unterschieden?',a:'<strong>1. Formale Rationalität:</strong> Entscheidung nach klar definierten Regeln, Verfahren und Zuständigkeiten (Legitimation durch Verfahren).<br><strong>2. Ökonomische Rationalität:</strong> Entscheidung nach Kosten-Nutzen-Kalkül und Wirtschaftlichkeitsprinzip (Minimal-/Maximalprinzip).<br><strong>3. Politische Rationalität:</strong> Entscheidung nach Interessenlagen, Machtstrukturen und Kompromissbereitschaft.<br><br><strong>Merke:</strong> Bei der Feuerwehr spielen alle drei Rationalitäten zusammen – formale Zuständigkeit, wirtschaftlicher Ressourceneinsatz und politische Akzeptanz müssen berücksichtigt werden.'},
