...
const FLASHCARD_DATA = [
  ...
  /* ── FeuAK Hamburg ─────────────────────────────────────── */
  {id:'h01',cat:'FeuAK · VWL',q:'Wie unterscheiden sich Mikro- und Makroökonomie in 4 Dimensionen?',a:'<strong>1. Untersuchungsobjekt:</strong> Mikro = einzelne Akteure (Haushalte, Betriebe); Makro = wirtschaftliches Gesamtsystem.<br><strong>2. Zielgröße:</strong> Mikro = individuelle Preise und Marktgleichgewichte; Makro = Aggregate wie Inflation und Wirtschaftswachstum.<br><strong>3. Perspektive:</strong> Mikro = Lupe auf den Markt; Makro = Vogelperspektive auf den Staat.<br><strong>4. Interdependenz:</strong> Mikro erklärt das Fundament; Makro dessen Gesamtwirkung auf die Volkswirtschaft.'},
  {id:'h02',cat:'FeuAK · VWL',q:'Was sind Opportunitätskosten? Nennen Sie 3 Feuerwehr-Kontexte.',a:'<strong>Definition:</strong> Kosten einer Entscheidung = Wert der besten entgangenen Alternative.<br><strong>1. Berufsfeuerwehr im Einsatz:</strong> Bereitstellungskosten (dauerhaftes Vorhalten), Alternativkosten (Steuergelder fehlen für Schulen/Straßen), Produktivitätsausfall.<br><strong>2. Großveranstaltungen:</strong> FW-Kräfte am Stadion gebunden → fehlen im restlichen Stadtgebiet → kostenpflichtige Abstimmung mit Nachbarkreisen.<br><strong>3. Ehrenamt (FF):</strong> Kameraden im Einsatz = fehlende Arbeitskraft → volkswirtschaftlicher Produktivitätsverlust und Belastung für Arbeitgeber.'},
  {id:'h03',cat:'FeuAK · VWL',q:'Welche 4 Kernbereiche umfasst die Volkswirtschaftslehre?',a:'<strong>1. Ressourcenallokation:</strong> Wie werden knappe Güter effizient verteilt?<br><strong>2. Marktmechanismen:</strong> Analyse des Zusammenspiels von Angebot und Nachfrage.<br><strong>3. Wirtschaftspolitik:</strong> Staatliche Eingriffe zur Stärkung der volkswirtschaftlichen Stabilität.<br><strong>4. Wohlstandsmaximierung:</strong> Steigerung des gesellschaftlichen Nutzens als übergeordnetes Ziel.'},
  {id:'h04',cat:'FeuAK · VWL',q:'Warum ist Brandschutz ein öffentliches Gut? Erläutern Sie die 2 Eigenschaften und das Trittbrettfahrer-Problem.',a:'<strong>Nicht-Ausschließbarkeit:</strong> Die Feuerwehr hilft jedem – unabhängig davon, ob er Steuern zahlt oder nicht.<br><strong>Nicht-Rivalität:</strong> Schutz für eine Bürger schmälert nicht die Sicherheit des Nachbarn.<br><strong>Trittbrettfahrer-Problem:</strong> Da alle profitieren, würde freiwillig kaum jemand zahlen → Unterversorgung durch Markt.<br><strong>Folge:</strong> Brandschutz muss zwingend gemeinschaftlich (staatlich) finanziert werden – er kann nicht dem freien Markt überlassen werden.'},
  {id:'h05',cat:'FeuAK · VWL',q:'Worin unterscheiden sich VWL und BWL? Nennen Sie 4 Dimensionen.',a:'<strong>1. Betrachtungsperspektive:</strong> VWL = gesamte Wirtschaft (Makro-Ebene); BWL = einzelnes Unternehmen (Mikro-Ebene).<br><strong>2. Zielsetzung:</strong> VWL = gesellschaftlicher Wohlstand; BWL = betrieblicher Gewinn.<br><strong>3. Markt vs. Betrieb:</strong> VWL erforscht Märkte und Preise; BWL steuert interne Prozesse wie Marketing und Logistik.<br><strong>4. Akteure:</strong> VWL lenkt Staaten und Wirtschaftspolitik; BWL berät Manager.'},
  ...
  {id:'h44',cat:'FeuAK · Vergabe',q:'Welche EU-Schwellenwerte gelten für Kommunen ab 1.1.2026 und welche Fristen im offenen Verfahren?',a:'<strong>Ab 1.1.2026 (§106 GWB):</strong><br>· Liefer- & DL sonstige öAG (Kommunen): <strong>216.000 €</strong> (zuvor: 221.000 €)<br>· Sektorenauftraggeber / Verteidigung: 432.000 €<br>· Bauaufträge / Konzessionen: <strong>5.404.000 €</strong> (zuvor: 5.538.000 €)<br><strong>Auftragswert:</strong> Gesamtwert ohne USt.; bei Blockbeschaffung Gesamtwert aller Lose maßgeblich.<br><strong>Fristen offenes Verfahren:</strong> Standard 52 Tage · elektronisch 30 Tage · Dringlichkeit 15 Tage.<br>Bekanntmachung: EU-Amtsblatt (TED).<br><em>Praxis FW: HLF 20 (700.000 €), DLK (900.000 €) liegen stets über dem Schwellenwert → EU-weites offenes Verfahren ist die Regel.</em>'},
  ...
  {id:'h46',cat:'FeuAK · VWL',q:'Erläutern Sie Minimal- und Maximalprinzip im taktischen Feuerwehrkontext.',a:'Beide sind Ausprägungen des <strong>ökonomischen Prinzips</strong> – taktische Effizienz bei Rettung und Brandbekämpfung.<br><strong>Minimalprinzip:</strong> Vorgegebenes Einsatzziel mit minimalem Mitteleinsatz erreichen.<br>&nbsp; → Beispiel: Brandbekämpfung mit geringstmöglichem Wasserschaden erzielen.<br><strong>Maximalprinzip:</strong> Vorhandene Kräfte (z. B. einen Löschtrupp) für maximalen Rettungserfolg einsetzen.<br>&nbsp; → Beispiel: Taktische Abwägung Ressourcensparsamkeit vs. maximale Wirkung an der Einsatzstelle.<br><strong>Ziel:</strong> Optimaler Schutz der Bevölkerung trotz limitierter Kapazitäten.'},
  ...
  {id:'h51',cat:'FeuAK · VWL',q:'Was ist „Swiftonomics"? Erläutern Sie Multiplikatoreffekt und Swiftflation.',a:'<strong>Swiftonomics:</strong> Phänomen der volkswirtschaftlichen Auswirkungen von Taylor Swifts Eras Tour – Lehrbeispiel für Ketteneffekte in der VWL.<br><strong>Multiplikatoreffekt:</strong> Konzertbesucher bringen Geld → fließt in Hotellerie, Transport, Einzelhandel → Ketteneffekt in der Gesamtwirtschaft.<br><strong>Swiftflation:</strong> Schlagartige Nachfrageexplosion → Preisanstieg bei Flügen und Hotels. In Schweden und Portugal kurzzeitig im nationalen Verbraucherpreisindex sichtbar.<br><strong>FW-Relevanz:</strong> Brandsicherheitswachen, Überstunden, gebundene Kräfte im Stadtgebiet, Opportunitätskosten.'},
  ...
  {id:'h54',cat:'FeuAK · VWL',q:'Was ist Knappheit als volkswirtschaftliches Grundproblem – und wie äußert sich das bei der Feuerwehr?',a:'<strong>Grundproblem:</strong> Ressourcen (Personal, Material, Zeit) sind immer limitiert – der Bedarf an Sicherheit ist theoretisch unbegrenzt.<br><strong>Kernkonflikt:</strong> Knappe Mittel vs. unvorhersehbar große Schadenslagen.<br><strong>FW-Konsequenz:</strong> Wirtschaftliches Handeln ist zwingend – die Feuerwehr muss mit dem Vorhandenen den größtmöglichen Schutz erzielen.<br><strong>Priorisierung:</strong> Knappheit erzwingt im Einsatz und im Verband harte Entscheidungen (Ressourcenallokation, Nachrangigkeit).'},
  ...
  /* ── FeuAK – Altklausur-Karten h61–h69 ── */
  {id:'h61',cat:'FeuAK · Haushalt',q:'Was sind die wesentlichen Besonderheiten des kommunalen Haushaltswesens im Vergleich zur Privatwirtschaft?',a:'<strong>Kein Gewinnziel:</strong> öffentlicher Auftrag der Daseinsvorsorge, nicht Gewinnmaximierung.<br><strong>Demokratische Legitimation:</strong> Haushalt als Satzung beschlossen (Gemeindeordnung).<br><strong>6 Haushaltsgrundsätze:</strong> Vollständigkeit · Einheit · Öffentlichkeit · Jährlichkeit · Sparsamkeit/Wirtschaftlichkeit · Vorherigkeit.<br><strong>Haushaltskreislauf:</strong> Aufstellung → Beratung → Beschluss → Vollzug → Jahresabschluss → Prüfung.<br><strong>Doppik-Struktur:</strong> Ergebnishaushalt (Ressourcenverbrauch, Abschreibungen, Pensionsrückstellungen) + Finanzhaushalt (Zahlungsströme).<br><strong>Haushaltssicherungskonzept (HSK)</strong> bei strukturellem Defizit.'},
  {id:'h62',cat:'FeuAK · BSC/QM',q:'Nennen Sie 5 Grundsätze des Qualitätsmanagements (QM) nach ISO 9001:2015.',a:'ISO 9001:2015 kennt 7 QM-Grundsätze; die 5 prüfungsrelevanten:<br><strong>1. Kundenorientierung:</strong> Bedürfnisse der Bevölkerung/Kunden erkennen und übertreffen.<br><strong>2. Führung:</strong> Führungskräfte schaffen gemeinsame Ziele, Ausrichtung und Engagement.<br><strong>3. Einbeziehung der Mitarbeiter:</strong> Mitarbeiter auf allen Ebenen befähigen und einbinden.<br><strong>4. Prozessorientierung:</strong> Aktivitäten als zusammenhängende Prozesse verstehen und steuern.<br><strong>5. Kontinuierliche Verbesserung (KVP):</strong> Ständige Verbesserung als dauerhaftes Organisationsziel.'},
  {id:'h63',cat:'FeuAK · BSC/QM',q:'Was sind Produkte, Kunden und Qualitätsmerkmale der Feuerwehr im Sinne des QM?',a:'<strong>Produkte:</strong> Abwehrender Brandschutz · Vorbeugender Brandschutz · Technische Hilfeleistung · Rettungsdienst · Aus- und Fortbildung.<br><strong>Kunden:</strong> Bevölkerung · Betriebe und Institutionen · Kommunalpolitik · andere Behörden · Versicherungen.<br><strong>Qualitätsmerkmale:</strong> Hilfsfristerfüllungsquote (90 % AGBF) · Funktionsstärke (10/16 EK) · Fachgerechtigkeit des Einsatzes · Schadensminimierung · Kundenzufriedenheit.'},
  {id:'h64',cat:'FeuAK · BSC/QM',q:'Welche Kennzahlen eignen sich für die BSC-Steuerung einer Berufsfeuerwehr?',a:'<strong>Finanzen:</strong> Kosten/Einsatz · Kostendeckungsgrad · Investitionsquote.<br><strong>Kunden:</strong> Hilfsfristerfüllungsquote (%) · Beschwerden · Zufriedenheitsbefragung.<br><strong>Prozesse:</strong> Ausrückzeit (Sek.) · Eintreffzeit (Min.) · Fahrzeugverfügbarkeit (%) · Einsatzdauer · Alarmierungsquote.<br><strong>Lernen/Entwicklung:</strong> Fortbildungsstunden/MA · AS-Geräteträgerquote (%) · Krankheitsquote (%) · Personalfluktuation · Beförderungsquote.'},
  {id:'h65',cat:'FeuAK · BSC/QM',q:'Was umfasst die strategische Personalplanung und welche Instrumente stehen zur Verfügung?',a:'Langfristige (5–10 Jahre) quantitative und qualitative Sicherung des Personalbedarfs.<br><strong>Bestandsanalyse:</strong> Altersstruktur · Qualifikationsmatrix · Laufbahnentwicklung.<br><strong>Bedarfsanalyse:</strong> Schutzziel, Risikoentwicklung, gesetzliche Mindestbesetzung.<br><strong>Lückenanalyse:</strong> Differenz Ist vs. Soll → Handlungsbedarf.<br><strong>Maßnahmen:</strong> Einstellungsplanung · Ausbildung · Beförderung · Versetzung · Ruhestandsplanung.<br><strong>Instrumente:</strong> Stellenplan · Personalentwicklungskonzept · Nachfolgeplanung · Mentoring · Potenzialbeurteilung.'},
  {id:'h66',cat:'FeuAK · Bedarfsplanung',q:'Welche Beschaffungsalternativen (Make-or-Buy) gibt es für ein HLF 20 und welche Bewertungskriterien sind relevant?',a:'<strong>Alternativen:</strong><br>1. <strong>Kauf:</strong> hohe Anschaffungskosten, volle Verfügbarkeit, Nutzungsdauer 15–25 J.<br>2. <strong>Leasing:</strong> niedrige Kapitalbelastung, Ratenzahlung, Rückgabe oder Kauf am Ende.<br>3. <strong>Interkommunale Zusammenarbeit:</strong> gemeinsame Beschaffung/Nutzung → Skaleneffekte.<br>4. <strong>Nutzungsgemeinschaft/Poolmodell:</strong> Kostenaufteilung nach Nutzung.<br><strong>Bewertungskriterien:</strong> Anschaffungskosten · Betriebskosten · Lebenszykluskosten (LCC) · Verfügbarkeit · Normkonformität (DIN EN 1846) · strategische Abhängigkeit · Refinanzierungszeitraum.'},
  {id:'h67',cat:'FeuAK · VWL',q:'Welche 5 Rollen hat der öffentliche Dienst im Wirtschaftskreislauf?',a:'<strong>1. Konsument- &amp; Steuerkraft:</strong> Mitarbeiter zahlen Steuern und kurbeln den privaten Konsum an.<br><strong>2. Staatskonsument:</strong> Beschafft Güter und Dienstleistungen direkt von der Privatwirtschaft (Fahrzeuge, Ausrüstung).<br><strong>3. Infrastruktur-Garant:</strong> Sichert die rechtlichen und physischen Grundlagen für wirtschaftliches Handeln.<br><strong>4. Ressourcen-Verteiler:</strong> Transformiert Steuergelder in öffentliche Güter und Dienstleistungen.<br><strong>5. Stabilitätsanker:</strong> Wirkt durch stetige Beschäftigung und Investitionen antizyklisch in Krisenzeiten.'},
  {id:'h68',cat:'FeuAK · VWL',q:'Warum ist die Feuerwehr ein Produktionsfaktor? Erläutern Sie den Begriff der indirekten Wertschöpfung.',a:'<strong>Produktionsfaktor:</strong> Sicherheit ist kein Luxus, sondern eine produktive Grundvoraussetzung – ohne verlässlichen Brandschutz kollabieren Lieferketten und Produktionsprozesse bei Unfällen.<br><strong>Indirekte Wertschöpfung:</strong> Die Feuerwehr produziert keine Güter, verhindert aber deren Zerstörung.<br><strong>Faktor Zeit:</strong> Schnelle Eingreifzeiten begrenzen Schäden auf ein Minimum.<br><strong>Betriebserhalt:</strong> Gelöschtes Firmengebäude = vermiedene Produktionsausfälle = gesicherte lokale Arbeitsplätze und Steuereinnahmen.<br><strong>Versicherungswirkung:</strong> Brandschutzauflagen senken Schadensrisiko → niedrigere Prämien für Unternehmen.'},
  {id:'h69',cat:'FeuAK · Rechnungswesen',q:'Skizzieren Sie den Aufbau einer Bilanz nach HGB und die Unterschiede zur kommunalen Doppik und Kameralistik.',a:'<strong>HGB-Bilanz:</strong><br>Aktiva: Anlagevermögen (Sachanlagen, immat. VG, Finanzanlagen) + Umlaufvermögen (Vorräte, Forderungen, Kasse).<br>Passiva: Eigenkapital + Rückstellungen + Verbindlichkeiten. Aktiva = Passiva.<br><br><strong>Kommunale Doppik:</strong> ähnlicher Aufbau; Besonderheiten: Pflichtmäßige <strong>Pensionsrückstellungen</strong> · Ergebnisrechnung (Ressourcenverbrauch + Abschreibungen) + Finanzrechnung (Zahlungsströme).<br><br><strong>Kameralistik:</strong> <em>Keine Bilanz</em> – nur Einnahmen-/Ausgabenrechnung · keine Abschreibungen · keine Rückstellungen → begrenzte Transparenz über Vermögen und Schulden.'},

  /* ── FeuAK · VWL – Neue Karten Modul 3.3 h70–h77 ── */
  {id:'h70',cat:'FeuAK · VWL',q:'Was ist eine positive Externalität? Erläutern Sie das Beispiel Brandschutz und Nachbarhäuser.',a:'<strong>Externalität:</strong> Auswirkungen einer wirtschaftlichen Tätigkeit, die nicht im Preis enthalten sind.<br><strong>Positive Externalität durch Brandschutz:</strong> Ein gelöschtes Feuer schützt automatisch die Nachbarhäuser vor dem Übergreifen (Riegelstellung).<br><strong>Marktversagen:</strong> Der einzelne Hauseigentümer zahlt nur für seinen eigenen Schutz – der Nutzen für die Allgemeinheit ist aber viel größer. Freiwillig würde er diesen gesellschaftlichen Mehrwert nicht finanzieren.<br><strong>Rechtfertigung:</strong> Der staatliche Brandschutz sichert diese positiven Auswirkungen auf die Allgemeinheit ab.'},
  {id:'h71',cat:'FeuAK · VWL',q:'Was ist Ressourcenmanagement und welche 4 Kernelemente hat es?',a:'<strong>Ressourcenmanagement:</strong> Effiziente Steuerung von Personal, Sachmitteln und Finanzen zur Sicherung der Aufgabenerfüllung.<br><strong>1. Allokationsfunktion:</strong> Gezielter Einsatz von Ressourcen für Kernaufgaben.<br><strong>2. Nachhaltigkeit:</strong> Langfristige Substanzerhaltung statt kurzfristiger Budgeterschöpfung.<br><strong>3. Risiko-Vorsorge:</strong> Strategische Pufferbildung sichert Handlungsfähigkeit in Krisenzeiten.<br><strong>4. Steuerungstool:</strong> Verknüpft Haushaltsmittel mit messbaren Leistungszielen (Output-Orientierung).'},
  {id:'h72',cat:'FeuAK · VWL',q:'Was unterscheidet Effizienz von Effektivität im Haushaltsrecht? Nennen Sie das Sparsamkeitsgebot.',a:'<strong>Effizienz:</strong> Die Dinge <em>richtig</em> tun – optimales Verhältnis von eingesetzten Mitteln (Input) zu Ergebnis (Output).<br><strong>Effektivität:</strong> Die <em>richtigen</em> Dinge tun – Zielerreichung unabhängig vom Mitteleinsatz.<br><strong>Sparsamkeitsgebot:</strong> Gesetzliche Pflicht (§7 BHO/LHO), staatliche Aufgaben mit geringstmöglichem Finanzaufwand zu erfüllen.<br><strong>Nutzenmaximierung:</strong> Größtmöglicher gesellschaftlicher Ertrag aus Steuergeldern ist das übergeordnete Ziel.'},
  {id:'h73',cat:'FeuAK · VWL',q:'Was umfasst Personalökonomie bei der Feuerwehr? Nennen Sie 3 Spannungsfelder.',a:'<strong>Personalökonomie:</strong> Effiziente Steuerung und Bereitstellung der knappen Ressource Mensch.<br><strong>1. Vorhaltung vs. Auslastung:</strong> Teure Abwägung zwischen ständiger Einsatzbereitschaft und tatsächlichen Einsatzzahlen – Bereitschaftspersonal kostet auch ohne Einsatz.<br><strong>2. Ehrenamt vs. Hauptamt:</strong> Freiwillige Strukturen sparen enorme Haushaltsmittel, belasten aber Arbeitgeber durch kurzfristige Abwesenheiten.<br><strong>3. Taktischer Personaleinsatz:</strong> Optimale Besetzung (z. B. gesetzliche Mindeststärke), um maximalen Rettungserfolg zu garantieren.'},
  {id:'h74',cat:'FeuAK · VWL',q:'Was sind Skaleneffekte (Economies of Scale)? Nennen Sie Vor- und Nachteile für die Feuerwehr.',a:'<strong>Skaleneffekte:</strong> Kostenvorteile durch größere Mengen oder zentrale Strukturen.<br><strong>Vorteile:</strong><br>· Gemeinsamer Einkauf von Fahrzeugen oder Kleidung → niedrigerer Stückpreis<br>· Gemeinsame Leitstelle für mehrere Kreise → spart Betriebs- und Technikkosten<br><strong>Nachteile:</strong><br>· Möglicher Verlust an lokaler Flexibilität und schneller Reaktionsfähigkeit<br>· Längere Entscheidungswege zwischen Kooperationspartnern<br>· Hoher Abstimmungsaufwand bei zentralisierten Strukturen'},
  {id:'h75',cat:'FeuAK · VWL',q:'Was ist TCO (Total Cost of Ownership) und warum ist es für die Fahrzeugbeschaffung entscheidend?',a:'<strong>TCO = Total Cost of Ownership / Investitionsrechnung:</strong> Der Anschaffungspreis ist nur ein Teil der Wahrheit.<br><strong>Gesamte Lebenszykluskosten</strong> umfassen: Anschaffung + Wartung + Treibstoff + TÜV + Reparaturen + Aussonderung.<br><strong>Praxis:</strong> Folgekosten übertreffen oft die Kaufsumme. Teurere, robustere Fahrzeuge sind langfristig wirtschaftlicher.<br><strong>Nutzen:</strong> Schützt Kommunen vor unvorhersehbaren finanziellen Altlasten; ermöglicht seriöse Budgetplanung über mehrere Legislaturperioden.'},
  {id:'h76',cat:'FeuAK · VWL',q:'Was ist eine Kosten-Nutzen-Analyse (KNA) und welche gesetzliche Grundlage schreibt sie vor?',a:'<strong>KNA:</strong> Vergleicht alle anfallenden Kosten und erwarteten Nutzen eines Projekts in Geldwerten.<br><strong>Gesetzliche Grundlage:</strong> Haushaltsgrundsätzegesetz (HGrG) – bei finanzwirksamen Maßnahmen vorgeschrieben.<br><strong>Entscheidungshilfe:</strong> Objektiviert die Auswahl zwischen Investitionsalternativen.<br><strong>Makro-Blick:</strong> Erfasst neben direkten Ausgaben auch gesellschaftliche Wohlfahrtseffekte.<br><strong>Priorisierung:</strong> Verhindert Fehlinvestitionen durch Nachweis des langfristigen Mehrwerts.<br><strong>Beispiel:</strong> Ein 500.000 €-Fahrzeug, das einen Millionenbrand verhindert, ist volkswirtschaftlich rentabel.'},
  {id:'h77',cat:'FeuAK · VWL',q:'Was sind Grenzkosten der Sicherheit? Erläutern Sie das Ertragsgesetz und die Effizienzgrenze.',a:'<strong>Grenzkosten der Sicherheit:</strong> Abwägung zwischen Kosten zusätzlicher Ausrüstung/Maßnahmen und dem tatsächlich verhinderten Schaden.<br><strong>Ertragsgesetz:</strong> Ab einem bestimmten Punkt bringt mehr Budget kaum noch zusätzliche Sicherheit (z. B. das fünfte Spezialfahrzeug).<br><strong>Risikomanagement:</strong> Rationale Budgetierung statt dem Versuch, jedes theoretische Restrisiko extrem teuer zu eliminieren.<br><strong>Effizienzgrenze:</strong> Ab wann kostet zusätzliche Sicherheit mehr, als sie an potenziellem Schaden verhindert? Dort liegt das wirtschaftliche Optimum.<br><strong>Statistischer Wert:</strong> VWL nutzt den „statistischen Wert eines Menschenlebens" für Budgetentscheidungen – stößt aber an ethische Grenzen.'},

  /* ── FeuAK · PM – Neue Karten v2.19 h78–h94 (Reihenfolge: Abschnitt 01→02→03→04→05→10) ── */
  {id:'h78',cat:'FeuAK · PM',q:'Was ist das Wohlfahrtsdreieck und welche Rolle nimmt die Feuerwehr darin ein?',a:'Das Wohlfahrtsdreieck beschreibt drei gesellschaftliche Sektoren, zwischen denen Dienstleistungen der Daseinsvorsorge angesiedelt sind:<br><br><strong>Staat (Öffentlicher Sektor):</strong> Gesetzlicher Rahmen, Daseinsvorsorge, hoheitliche Aufgaben – die Feuerwehr ist originär hier angesiedelt.<br><strong>Markt (Privater Sektor):</strong> Gewinnorientierte Anbieter; durch New Public Management zunehmend auch im Bereich der Daseinsvorsorge präsent.<br><strong>Dritter Sektor (Gesellschaft):</strong> Non-Profit-Organisationen, Hilfsorganisationen, Freiwillige – Grenzen zu Staat und Markt sind fließend.<br><br><strong>Feuerwehr:</strong> Operiert an den Schnittstellen aller drei Bereiche. Seit den 1990er Jahren sind Grenzen zunehmend fließend.'},
  {id:'h79',cat:'FeuAK · PM',q:'Was ist Prosumption und welche 4 Dienstleistungstypen werden unterschieden?',a:'<strong>Prosumption:</strong> Kunstwort aus „Produzent" + „Konsument": Leistungserstellung erfolgt nur unter aktiver Mitwirkung des „Kunden". Ein unkooperativer Konsument kann den Leistungsprozess erheblich stören.<br><br><strong>4 Dienstleistungstypen:</strong><br><strong>Typ I – Person → Person:</strong> Immaterielle Leistung unter Kundenbeteiligung (Unternehmensberatung, Gesundheit, Erziehung).<br><strong>Typ II – Person → Objekt:</strong> Materielle Leistungsergebnisse unter Kundenbeteiligung → <em>wahrscheinliche Einordnung der Feuerwehr</em>.<br><strong>Typ III – Objekt → Objekt:</strong> Materielle Leistung, weitgehend autonom (Wäscherei, vorproduzierte Teile).<br><strong>Typ IV – Objekt → Person:</strong> Immaterielle Leistung, weitgehend autonom (Datenbankdienste, ÖPNV).<br><br><strong>Besonderheit FW:</strong> Situativ kann auch Typ I zutreffen – strategisches Management bei der Feuerwehr ist ein Sonderfall.'},
  {id:'h80',cat:'FeuAK · PM',q:'Welche 3 Wettbewerbsstrategien (Strategietypen) unterscheidet Porter und wie gelten sie für die Feuerwehr?',a:'<strong>1. Kostenführerstrategie:</strong> Ziel: Preisgünstigster Wettbewerber sein → Kostenvorteile durch Standardisierung und Skalierung.<br><strong>2. Differenzierungsstrategie:</strong> Ziel: Abhebung von Konkurrenzprodukten durch besondere Qualität oder Leistung.<br><strong>3. Nischenstrategie:</strong> Ziel: Ausrichtung auf ein eng bestimmtes Käufersegment.<br><br><strong>FW-Übertragung:</strong> Da die Feuerwehr ohne Markt agiert (kein Wettbewerb), sind Porters Strategietypen nur eingeschränkt anwendbar. Sie helfen jedoch, strategische <em>Effizienz</em>- und <em>Qualitätsziele</em> zu beschreiben.'},
  {id:'h81',cat:'FeuAK · PM',q:'Was ist die Strategiedefinition nach Gälweiler und welche Besonderheit gilt bei der Feuerwehr?',a:'<strong>Gälweiler:</strong> Organisationen handeln dann <strong>strategisch</strong>, wenn sie Erfolgspotenziale sichern oder aufbauen.<br><br><strong>Besonderheiten der Feuerwehr (ohne Markt):</strong><br>· <strong>Kein Wettbewerb:</strong> Kein Konkurrenzdruck – der Leistungsauftrag ist gesetzlich fixiert.<br>· <strong>Hohe Fremdsteuerung:</strong> Politische und gesellschaftliche Steuerung hinsichtlich Ausstattung und Erwartungshaltung.<br>· <strong>Strategieziel:</strong> Effizienzsteigerung, Qualitätsverbesserung und Zukunftssicherung statt Gewinnmaximierung.'},
  {id:'h82',cat:'FeuAK · PM',q:'Aus welchen 5 Ebenen besteht die Strategiehierarchie?',a:'<strong>1. Vision</strong> – Zukunftsbild: Wohin wollen wir? (normative Orientierung)<br><strong>2. Mission</strong> – Auftrag und Zweck der Organisation (warum existieren wir?)<br><strong>3. Strategie</strong> – langfristiger Handlungsplan zur Erreichung der Vision<br><strong>4. Operationalisierung</strong> – konkrete Maßnahmen, Projekte und Ziele<br><strong>5. Performance Measurements</strong> – Kennzahlen zur Messung der Zielerreichung<br><br><strong>Wesen des Strat. Mgmts.:</strong> Analyse (SWOT) → Prognose (VUKA/BANI) → Entscheidung.'},
  {id:'h83',cat:'FeuAK · PM',q:'Nennen Sie die 8 strategischen Handlungsfelder der Feuerwehr.',a:'<strong>1. Personal</strong> – Gewinnung, Bindung, Entwicklung; Nachwuchssicherung.<br><strong>2. Technologie</strong> – Digitalisierung, KI in der Leitstelle, smarte Sensorik, Telemedizin.<br><strong>3. Organisation</strong> – Strukturen, Prozesse, Schichtmodelle, Aufbauorganisation.<br><strong>4. Finanzierung</strong> – Haushaltssicherung, Umgang mit Haushaltsknappheit und Investitionsstau.<br><strong>5. Kommunikation</strong> – Interne/externe Kommunikation, Öffentlichkeitsarbeit, Stakeholder-Kommunikation.<br><strong>6. Kooperation</strong> – Zusammenarbeit mit Polizei, Rettungsdienst, Katastrophenschutz.<br><strong>7. Risikomanagement</strong> – Prospektive Risikoanalyse, Krisenmanagement, Einsatzbereitschaft.<br><strong>8. Nachhaltigkeit</strong> – ökologische, soziale und wirtschaftliche Nachhaltigkeit.'},
  {id:'h84',cat:'FeuAK · PM',q:'Was sind Nicht-Entscheidungen und welche 3 Typen gibt es?',a:'<strong>Nicht-Entscheidungen</strong> sind Entscheidungsprozesse, bei denen keine rationalen Abwägungen stattfinden. Sie sind als Führungsfehler zu vermeiden.<br><br><strong>1. Gefühlsgeleitet:</strong> Entscheidung basiert auf Emotionen statt auf Analyse.<br><strong>2. Traditionell:</strong> „Das haben wir immer so gemacht" – Tradition ersetzt rationale Prüfung der Alternativen.<br><strong>3. Routiniert:</strong> Automatisiertes Handeln ohne Reflexion – Routine verdrängt die bewusste Entscheidung.'},
  {id:'h85',cat:'FeuAK · PM',q:'Welche 3 Rationalitäten der Entscheidung werden in der Entscheidungstheorie unterschieden? Was ist Ambiguitätstoleranz?',a:'<strong>1. Formale Rationalität:</strong> Entscheidung nach klar definierten Regeln, Verfahren und Zuständigkeiten (Legitimation durch Verfahren).<br><strong>2. Ökonomische Rationalität:</strong> Entscheidung nach Kosten-Nutzen-Kalkül und Wirtschaftlichkeitsprinzip (Minimal-/Maximalprinzip).<br><strong>3. Politische Rationalität:</strong> Entscheidung nach Interessenlagen, Machtstrukturen und Kompromissbereitschaft.<br><br><strong>Ambiguitätstoleranz:</strong> Da keine Rationalität zu 100 % erfüllt werden kann, entstehen bei jeder Entscheidung Defizite. Entscheidungsträger müssen Entscheidungen treffen und gegenüber Dritten vertreten, die aus der Perspektive einzelner Rationalitäten bessere Alternativen hätten. Dafür benötigen sie eine ausgeprägte <strong>Ambiguitätstoleranz</strong> – die Fähigkeit, Mehrdeutigkeit und Unentscheidbarkeit auszuhalten, ohne in eine Nicht-Entscheidung zu verfallen.'},
  {id:'h86',cat:'FeuAK · PM',q:'Was ist die Nutzwertanalyse und wie funktioniert sie?',a:'Methode zur Bewertung von Alternativen anhand mehrerer <strong>gewichteter Kriterien</strong>.<br>Jede Alternative erhält einen <strong>Nutzwert</strong> als Summe aller gewichteten Einzelbewertungen.<br><br><strong>Ohne Ausschlusskriterium:</strong> Alle Alternativen werden bewertet – die Alternative mit dem höchsten Nutzwert gewinnt.<br><strong>Mit Ausschlusskriterium:</strong> Alternativen, die ein Mindestkriterium nicht erfüllen, werden vorab ausgeschieden; danach Nutzwertanalyse der verbleibenden Optionen.<br><br><strong>Vorteil:</strong> Macht komplexe Entscheidungen transparent und vergleichbar.'},
  {id:'h87',cat:'FeuAK · PM',q:'Aus welchen 3 Bestandteilen setzt sich eine strategische Vision zusammen?',a:'<strong>1. Hauptziel:</strong> Was wollen wir als Organisation erreichen? (inhaltliche Zielrichtung)<br><strong>2. Einschränkung:</strong> Welche Grenzen oder Rahmenbedingungen müssen eingehalten werden?<br><strong>3. Zeitangabe:</strong> Bis wann soll das Ziel erreicht werden? (zeitlicher Horizont)<br><br><strong>Normative Problematik:</strong> Eine Vision ist immer eine <em>normative Entscheidung</em>, die Werthaltungen und Prioritäten widerspiegelt – und daher angreifbar ist.'},
  {id:'h88',cat:'FeuAK · PM',q:'Welche 6 Entscheidungsarten der Unternehmensleitung werden unterschieden?',a:'<strong>1. Grundsatzentscheidung:</strong> Existenz, Ziele, Strategien, Führungsstil (z. B. Gründung, Fusion, kooperativer Führungsstil).<br><strong>2. Führungsprozessentscheidung:</strong> Planung, Realisierung, Kontrolle (z. B. Strategische Planung, Akquise, Strategische Kontrolle).<br><strong>3. Organisationsentscheidung:</strong> Leitungsorganisation, Organisationsform (z. B. Stab-Linien-Organisation).<br><strong>4. Bereichsentscheidung:</strong> Finanz-, Personal-, Marketingpolitik (z. B. Investitionsentscheidungen).<br><strong>5. Abschlussentscheidung:</strong> Jahresabschluss, Berichterstattung (z. B. Lagebericht, Bilanzpolitik).<br><strong>6. Sonstige Entscheidung:</strong> Vertretung, Datenschutz, Mitarbeiterentwicklung (z. B. Repräsentation nach außen).'},
  {id:'h89',cat:'FeuAK · PM',q:'Welche 10 Führungsrollen unterscheidet Mintzberg in 3 Rollenbündeln?',a:'<strong>Interpersonale Rollen:</strong><br>· <strong>Galionsfigur</strong> – repräsentative Funktion nach außen<br>· <strong>Anführer</strong> – Motivation und Führung der Mitarbeiter<br>· <strong>Vernetzer</strong> – Aufbau und Pflege externer Kontakte<br><br><strong>Informationsbezogene Rollen:</strong><br>· <strong>Beobachter</strong> – Sammlung und Auswertung von Informationen<br>· <strong>Verteiler</strong> – Weitergabe intern<br>· <strong>Sprecher</strong> – Weitergabe nach außen<br><br><strong>Entscheidungsbezogene Rollen:</strong><br>· <strong>Unternehmer</strong> – Initiierung von Veränderungen<br>· <strong>Störungsregulator</strong> – Reaktion auf unvorhergesehene Probleme<br>· <strong>Ressourcenzuteiler</strong> – Vergabe von Personal, Budget und Zeit<br>· <strong>Verhandlungsführer</strong> – Verhandlungen intern und extern'},
  {id:'h90',cat:'FeuAK · PM',q:'Welche 2 Führungseigenschaften beschreibt Clausewitz und was bedeuten sie?',a:'<strong>Coup d\'œil</strong> (Blick für das Wesentliche): Die Fähigkeit, in unübersichtlichen Situationen schnell und treffsicher das Entscheidende zu erkennen.<br><br><strong>Entschlossenheit</strong> (Umsetzungsstärke): Die Fähigkeit, trotz Unsicherheit und unvollständiger Information eine Entscheidung zu treffen und konsequent umzusetzen.<br><br><strong>FW-Relevanz:</strong> Beide Eigenschaften sind im Einsatz unverzichtbar – Lagebeurteilung unter Druck + sofortiges Handeln ohne Vollständigkeit aller Informationen.'},
  {id:'h91',cat:'FeuAK · PM',q:'Was beschreibt das VUKA-Modell und wie überträgt es sich auf die Feuerwehr?',a:'<strong>V</strong>olatilität – häufige, unerwartete Veränderungen im Umfeld.<br><strong>U</strong>nsicherheit – mangelnde Vorhersehbarkeit künftiger Entwicklungen.<br><strong>K</strong>omplexität – viele vernetzte Einflussfaktoren.<br><strong>A</strong>mbiguität – Unklarheit über Ursache-Wirkungs-Zusammenhänge.<br><br><strong>FW-Transfer:</strong><br>· Volatilität → neues Einsatzspektrum (Klimaereignisse, hybride Bedrohungen)<br>· Unsicherheit → demografischer Wandel, Fachkräftemangel<br>· Komplexität → Vernetzung mit Polizei, Rettungsdienst, Katastrophenschutz<br>· Ambiguität → unklare Verantwortlichkeiten bei Cyberangriffen, Pandemien'},
  {id:'h92',cat:'FeuAK · PM',q:'Was ist das BANI-Modell (Cascio 2020) und was unterscheidet es von VUKA?',a:'<strong>B</strong>rittle (spröde) – scheinbar stabile Systeme brechen plötzlich unter Druck zusammen.<br><strong>A</strong>nxious (ängstlich) – Angst vor Fehlentscheidungen hemmt das Handeln.<br><strong>N</strong>on-linear – kleine Ursachen führen zu unverhältnismäßig großen Wirkungen.<br><strong>I</strong>ncomprehensible – Komplexität übersteigt individuelle Verständnisfähigkeit.<br><br><strong>Unterschied:</strong> VUKA beschreibt die <em>Eigenschaften des Umfeldes</em>; BANI beschreibt die <em>menschliche Reaktion</em> darauf. Kombiniert (VUKABANI) bieten beide Modelle eine umfassende Grundlage für strategische Prognosearbeit.'},
  {id:'h93',cat:'FeuAK · PM',q:'Wie läuft die prospektive Risikoanalyse in 4 Schritten ab?',a:'<strong>Grundlage:</strong> Wertkette einer Feuerwache – Nutzenversprechen, Wertschöpfungskette, Ertragsmechanik.<br><br><strong>1. Suche der Indikatoren:</strong> Entscheidende Erfolgsfaktoren intern (Primäraktivitäten, Schlüsselressourcen) und extern (Personal-, Kapital-, Beschaffungs-, Absatzmarkt).<br><strong>2. Benotung:</strong> Note 1 (sehr gut) bis 5 (mangelhaft); externe Indikatoren: auch künftige Entwicklungen einbeziehen.<br><strong>3. Gewichtung:</strong> 30 Punkte auf alle Indikatoren verteilen. Je wichtiger, desto mehr Punkte; unabhängig von der Note.<br><strong>4. Ergebnisermittlung:</strong> Note × Gewichtung = Ergebnis. ≥ 11 Punkte: sehr bedenklich → Fragen an Geschäftsleitung. &lt; 4 Punkte: relativ unbedenklich.'},
  {id:'h94',cat:'FeuAK · PM',q:'Was sind exogene und endogene Treiber der Veränderung in der prospektiven Risikoanalyse?',a:'<strong>Exogene Treiber (von außen):</strong><br>· Demografischer Wandel – mehr Pflegebedarf, Fachkräftemangel<br>· Technologischer Fortschritt – Digitalisierung, KI, Big Data<br>· Klimawandel – Extremwetter, Hochwasser, Waldbrände<br>· Globalisierung – Lieferketten, Pandemien<br>· Sicherheitslage – Terrorismus, Cyberangriffe, hybride Bedrohungen<br><br><strong>Endogene Treiber (systemintern):</strong><br>· Finanzielle Rahmenbedingungen – Haushaltsknappheit, Investitionsstau<br>· Gesellschaftlicher Wertewandel – Transparenz, Partizipation<br>· Fachkräftemangel – Nachwuchsgewinnung, Konkurrenz Privatwirtschaft<br>· Kooperationsdruck – intersektorale Zusammenarbeit<br>· Politisch-rechtliche Rahmenbedingungen – NPM, EU-Vorgaben'},
  {id:'h95',cat:'FeuAK · Haushalt',q:'Was ist der kommunale Finanzausgleich – und was ist er ausdrücklich NICHT?',a:'Der Finanzausgleich gleicht <strong>Finanzkraftunterschiede</strong> zwischen Ländern bzw. Kommunen aus – er ist <strong>kein Defizitausgleich</strong>.<br><br><strong>Länderfinanzausgleich:</strong> Ausgleich zwischen Bundesländern aus dem Landessteueraufkommen; Ziel: gleichwertige Lebensbedingungen im Bundesgebiet.<br><strong>Kommunaler Finanzausgleich:</strong> Das Land leitet Mittel aus Landessteuern an finanzschwächere Kommunen weiter.<br><br><strong>Merke:</strong> Gemeindesteuern (Gewerbesteuer, Grundsteuer) sind ein <em>eigenständiger</em> Einnahmeweg der Kommunen – sie sind nicht Teil des Finanzausgleichs.'},
  {id:'h96',cat:'FeuAK · Haushalt',q:'Welche 5 Ebenen hat die Produktpyramide der Feuerwehr?',a:'<strong>1. Bereich</strong> – z. B. Dezernat Öffentliche Sicherheit und Ordnung<br><strong>2. Produktgruppe</strong> – z. B. Gefahrenabwehr / Feuerwehr<br><strong>3. Produkt</strong> – z. B. Brandschutz, Technische Hilfe, Rettungsdienst. Muss steuerungsrelevant und unter <em>eine</em> Verantwortung gestellt sein.<br><strong>4. Leistung</strong> – z. B. vorbeugender / abwehrender Brandschutz, Notfallversorgung<br><strong>5. Tätigkeit</strong> – z. B. Bescheide erstellen, Besichtigungen durchführen<br><br><strong>Zwei Steuerungsebenen:</strong> Strategisch = Haushalt als „Vertrag" zwischen Politik und Verwaltung · Operativ = KLR und internes Controlling auf Produkt-/Kostenstellenebene.'},
  {id:'h97',cat:'FeuAK · Haushalt',q:'Was sind Verpflichtungsermächtigungen (VE), Investitionsprogramm (IP) und Stellenplan?',a:'<strong>Verpflichtungsermächtigungen (VE):</strong> Haushalterisches Werkzeug – heute einen Vertrag unterschreiben für ein System, das erst in späteren Jahren geliefert und bezahlt wird. Sichert Planungssicherheit über das laufende Haushaltsjahr hinaus.<br><br><strong>Deckungsfähigkeit:</strong> Budgets können umgeschichtet werden (z. B. Helm-Budget für Stiefel nutzen).<br><strong>Übertragbarkeit:</strong> Nicht verbrauchte Mittel sichern auf das Folgejahr (Ermächtigungsübertragungen / „Reste").<br><br><strong>Investitionsprogramm (IP):</strong> Teil des Finanzhaushalts – 5-Jahres-Planung aller Investitionsvorhaben. Grundlage für VE. Großbeschaffungen müssen 5 Jahre im Voraus geplant sein.<br><strong>Stellenplan:</strong> Parlamentsermächtigung für jede Stelle – Beamten- und Beschäftigtenstellen getrennt. Neue Stellen erst besetzbar, wenn Stellenplan rechtskräftig ist.'},
  {id:'h98',cat:'FeuAK · Haushalt',q:'Was ist der Unterschied zwischen investiven und konsumtiven Ausgaben? Nennen Sie je 2 Beispiele.',a:'<strong>Investiv (Finanzhaushalt):</strong> Anschaffungen mit bleibendem Vermögenswert, langfristige Nutzung.<br>Beispiele: Feuerwehrfahrzeug · Gebäude · Software-Lizenzen (Vermögenswert)<br><br><strong>Konsumtiv (Ergebnishaushalt):</strong> Laufende Ausgaben, Verbrauchsgüter – kein bleibender Vermögenswert.<br>Beispiele: jährlicher Software-Support · TÜV-Prüfungen · Kraftstoff · Verbrauchsmaterial<br><br><strong>Praxis:</strong> Beim Kauf eines RTW ist das Fahrgestell <em>investiv</em>, die laufenden TÜV-Prüfungen und Medizingeräte-Eichungen sind <em>konsumtiv</em>.'},
  {id:'h99',cat:'FeuAK · Haushalt',q:'Was sind überplanmäßige und außerplanmäßige Ausgaben, und welche 3 Bedingungen gelten für ihre Genehmigung?',a:'<strong>Überplanmäßige Ausgaben:</strong> Haushaltsansatz ist nicht ausreichend – Mehrkosten entstehen bei einer schon geplanten Position.<br><strong>Außerplanmäßige Ausgaben:</strong> Die Ausgabe war im Haushalt gar nicht vorgesehen.<br><br><strong>Genehmigungsbedingungen (Kämmerer):</strong><br>1. Ausgabe war zum Zeitpunkt der Planung <em>nicht vorhersehbar</em><br>2. Ausgabe <em>muss</em> noch in diesem Haushaltsjahr stattfinden<br>3. <em>Deckung</em> muss gewährleistet sein<br><br><strong>„Todsünden" der Budgetierung:</strong> (1) Budget abschöpfen – Restmittel am Jahresende einziehen statt übertragen. (2) Budget kürzen – wer spart, bekommt im Folgejahr weniger. Beide zerstören den Sparanreiz und führen zu strategischem Dezemberausgeben.'},
  {id:'h100',cat:'FeuAK · Haushalt',q:'Wie unterscheiden sich Kameralistik und Doppik? Was sind Lebenszykluskosten?',a:'<strong>Kameralistik:</strong> Kassensteuerung – erfasst nur Ein- und Auszahlungen eines Haushaltsjahres. Zeigt Liquidität, vernachlässigt Vermögenswerte und Werteverzehr (Abschreibungen). Einfach und klar, greift bei komplexem Ressourcenmanagement zu kurz.<br><br><strong>Doppik:</strong> Kaufmännisches Prinzip – doppelte Buchführung mit Bilanz, Ergebnis- und Finanzrechnung. Erfasst periodengerechten Werteverzehr (Abschreibungen), zeigt tatsächliches Vermögen und Schulden, sichert Generationengerechtigkeit.<br><br><strong>Aufwand ≠ Ausgabe:</strong> Abschreibungen sind Aufwand (Ressourcenverbrauch), aber keine laufende Auszahlung.<br><br><strong>Lebenszykluskosten:</strong> Der Anschaffungspreis ist nur die Spitze des Eisbergs. Folgekosten (Wartung, TÜV, Reparaturen) machen den Großteil des Budgets aus und müssen bereits bei der Beschaffung eingeplant werden.'},
  {id:'h101',cat:'FeuAK · Haushalt',q:'Was ist Controlling in der Feuerwehr – intern vs. extern? Welche Kennzahlen sind steuerungsrelevant?',a:'Controlling = <strong>planen → kontrollieren → nachsteuern</strong>. Absolute Führungsaufgabe der FW-FK; bei größeren Feuerwehren eigene Stabstelle.<br><br><strong>Internes Controlling:</strong> Adressat: Fachbereichsleitung, Amtsleitung. Detaillierte operative Kennzahlen – z. B. Ausrückezeiten je Wache, Kosten je Einsatz, Budgetstand je Kostenstelle. Ermöglicht kurzfristiges Nachsteuern.<br><br><strong>Externes Controlling:</strong> Adressat: Politik, Bürgerschaft. Hochaggregierte Berichte – z. B. Schutzzielerreichungsgrad, Budgetstand, Haushaltsentwicklung. Grundlage für politische Entscheidungen.<br><br><strong>Strategische Bedeutung:</strong> Eine valide Zeitreihe von Kennzahlen ist das beste Argument in Ressourcenverteilungskämpfen. Bereiche ohne Kennzahlen verlieren bei Kürzungsdebatten.'},
  {id:'h102',cat:'FeuAK · Haushalt',q:'Welche 4 steuerungsrelevanten Teilprozesse der Gefahrenabwehr kennt das Prozessmanagement – und welche Kennzahlen leiten sich ab?',a:'<strong>1. Notrufannahme & Disposition</strong> – Kennzahlen: Zeit bis Annahme, Fehldispositionsrate, Parallelgespräche. Steuerungsrelevanz: Engpass bei hohem Aufkommen → Personalbedarf Leitstelle.<br><br><strong>2. Ausrückezeit</strong> – Zeit von Alarmierung bis Abfahrt. Abhängig von Wachbesetzung, Schichtstärke, Tageszeit. Direkt steuerungsrelevant für Schutzziele.<br><br><strong>3. Fahrzeit</strong> – Zeit von Abfahrt bis Eintreffen. Grundlage für Standortentscheidungen und Bedarfsplanung.<br><br><strong>4. Gesamtfrist (Schutzzielerreichung)</strong> – Notruf + Ausrückezeit + Fahrzeit = messbare Kenngröße, ob das Schutzmodell funktioniert.<br><br><strong>Merke:</strong> Nur wer Prozesse kennt, kann sie messen, steuern und daraus Kennzahlen ableiten.'},
  {id:'h103',cat:'FeuAK · Haushalt',q:'Was ist der PDCA-Regelkreis, und wie ist der Brandschutzbedarfsplan (BEP) als Qualitätsinstrument aufgebaut?',a:'<strong>PDCA-Regelkreis (QM als NSM-Element 8):</strong><br><strong>P</strong>lan – Problem analysieren, Lösung entwickeln.<br><strong>D</strong>o – Lösung realisieren (zunächst im Pilotmaßstab).<br><strong>C</strong>heck – Ergebnisse evaluieren, Zielerreichung prüfen.<br><strong>A</strong>ct – Erfolgreiche Lösung standardisieren; sonst neuer Zyklus.<br><br><strong>Brandschutzbedarfsplan (BEP):</strong> Fachliches Pendant zur mittelfristigen Haushaltsplanung.<br>· <strong>Schutzziele</strong> – politisch definierte Mindeststandards (z. B. „10 Kräfte in 8 Minuten bei 90 % der Lagen")<br>· <strong>Mengenbezugsgrößen</strong> – Einsatzzahlen, Einwohnerzahl, Fläche<br>· <strong>Maßnahmen & Kennzahl</strong> – Abarbeitungsgrad der BEP-Maßnahmen<br><br><strong>Empfehlung:</strong> BEP mit Haushalt verknüpfen – ohne Mittel nicht umsetzbar, ohne BEP fachlich nicht begründbar.'},
  {id:'h104',cat:'FeuAK · Haushalt',q:'Was muss bei der Markterkundung beachtet werden, und was ist bei Wartungsverträgen wichtig?',a:'<strong>Neutrales Leistungsverzeichnis:</strong> Bedarfe müssen exakt und <em>herstellerneutral</em> beschrieben werden. Es ist rechtswidrig, bestimmte Hersteller zu bevorzugen.<br>✅ Zulässig: Fahrzeugmessen besuchen, verschiedene Softwareanbieter einladen, funktionale Mindestanforderungen formulieren.<br>🚫 Verboten: Wettbewerbsverzerrende Absprachen mit Herstellern (Kartellverbot).<br><br><strong>Beispiel RTW:</strong> ❌ „Mercedes-Benz Sprinter mit Aufbau Firma X" · ✅ „Fahrgestell mind. 160 PS mit Kofferaufbau Mindestmaß X/Y/Z"<br><br><strong>Vertragsmanagement – Wartungsverträge:</strong><br>· Langfristige Bindung: Mittel über Jahre gebunden, potenzielle Kostensteigerungen beachten<br>· Rechtssicherheit: Compliance schützt vor Vergabefehlern<br>· Kostenkontrolle: transparente Verträge verhindern unvorhersehbare Folgekosten<br>· Spenden/Sponsoring: müssen über den Rat laufen (kommunale Annahmerichtlinien)'},
  {id:'h105',cat:'FeuAK · Haushalt',q:'Wer kontrolliert das Handeln der Feuerwehr, und nach welchen Kriterien prüft die Rechnungsprüfung?',a:'<strong>Kontrollinstitutionen:</strong><br>· Grundsätzlich jeder Mitarbeitende des öffentlichen Dienstes<br>· Innenrevision & Rechnungshof (nachgelagert, strikt)<br>· Parlament (Große Anfragen, Sonderkontrollausschüsse)<br>· Bürger (Anfragen gem. Transparenzgesetz)<br><br><strong>Vergabevermerk-Pflicht:</strong> Jede Vergabeentscheidung – vom abgelehnten Angebot bis zur Eilbeschaffung – muss lückenlos schriftlich nachvollziehbar sein.<br><br><strong>4 Prüfkriterien der Rechnungsprüfung:</strong><br>1. <strong>Rechtmäßigkeit</strong> – strikte Kontrolle aller Ausgaben<br>2. <strong>Budgeteinhaltung</strong> – Haushaltsansätze eingehalten?<br>3. <strong>Wirtschaftlichkeit</strong> – sparsam und zweckmäßig?<br>4. <strong>Haushaltsgrundsätze</strong> – Kernregeln eingehalten?<br><br><strong>Konsequenzen von Fehlern:</strong> Vergaberügen, Budgetsperren, Haftungsrisiken, Reputationsverlust.'},

  /* ── FeuAK – Beschaffungspraxis ── */
  {id:'h106',cat:'FeuAK · Beschaffungspraxis',q:'Welche 4 Anlassfaktoren führen zur Ersatzbeschaffung eines Feuerwehrfahrzeugs, und wie haben sich die Preise entwickelt?',a:'<strong>Anlassfaktoren:</strong> Alter · Laufleistung/technischer Zustand · steigender Instandhaltungsaufwand · neue einsatztaktische Anforderungen (Normen, Technik, Hygiene).<br><strong>Kostensteigerung LF-Grundfahrzeug (FF):</strong> 2000: 230.000 € → 2020: 460.000 € → 2026: 650.000 €.<br>Ursachen: Technologie (kraftunterstützte Fahrtragen), Pandemie, Ukraine-Krieg (Rohstoffe, Energie, Transport). Keine Kompensation durch Mehrbudget → Investitionsstau.<br><strong>Lieferzeiten:</strong> 2–3,5 Jahre → Planung muss sehr frühzeitig beginnen.'},
  {id:'h107',cat:'FeuAK · Beschaffungspraxis',q:'Welche planmäßigen Nutzungsdauern gelten für Feuerwehrfahrzeuge (BF/FF) und welche 3 Reservekategorien gibt es?',a:'<strong>Nutzungsdauern (Erfahrungswerte FW Hamburg):</strong><br>· ELW/KdoW BF: 12 Jahre · HLF BF: 15 Jahre, FF: 20 Jahre · DLK BF: 15 Jahre<br>· RTW: 7 Jahre (Trend: 5) · NEF: 4 Jahre (Trend: 3) · Sonderfahrzeuge: 15–20 J. (AB bis 30 J.)<br><strong>Reservekonzept:</strong><br>· Technische Reserve – Fahrzeug in Werkstatt/sofort verfügbar<br>· Taktische Reserve – für vorhersehbare Mehrbedarfe (Großlagen)<br>· Strategische Reserve – für unvorhersehbare, langfristige Ausfälle<br><em>Im Jahr 12 der Nutzungsdauer mit Beschaffungsplanung beginnen (ca. 5 Jahre Vorlauf).</em>'},
  {id:'h108',cat:'FeuAK · Beschaffungspraxis',q:'Was ist Vergaberecht, wie ist es zweigeteilt und was gilt für die Feuerwehr?',a:'<strong>Definition:</strong> Vergaberecht regelt nicht was, sondern wie öffentliche Auftraggeber Waren, Bau- und Dienstleistungen beschaffen. Es ist Vertragsanbahnungsrecht – das Verfahren ist Mittel, der Vertrag der Zweck.<br><strong>Zweiteilung:</strong><br>· Oberschwellenbereich → EU-/Bundesrecht (GWB, VgV): Kartellvergaberecht<br>· Unterschwellenbereich → Landesrecht (UVgO, Landesvergabegesetze): Haushaltsvergaberecht<br><strong>Ausnahmen (§107 GWB):</strong> Rettungsdienst (gemeinnützige Hilfsorganisationen), Inhouse-Geschäfte (§108 GWB).'},
  {id:'h109',cat:'FeuAK · Beschaffungspraxis',q:'Was sind die EU-Schwellenwerte ab 1.1.2026 (§106 GWB) und was gilt für die Auftragswertschätzung (§3 VgV)?',a:'<strong>Ab 1.1.2026:</strong><br>· Liefer-/DL sonstige öAG (Kommunen): <strong>216.000 €</strong> · Sektorenauftraggeber: 432.000 € · Bauaufträge: 5.404.000 €<br><strong>Auftragswertschätzung (§3 VgV):</strong> Maßgeblich ist der voraussichtliche <strong>Gesamtwert ohne USt.</strong> Maßgeblicher <strong>Zeitpunkt</strong> = Tag der Einleitung des Vergabeverfahrens (<strong>Tag der Auftragsbekanntmachung</strong>). <strong>Optionen und Vertragsverlängerungen</strong> sind in die Schätzung einzubeziehen. Bei Blockbeschaffungen: Gesamtwert aller Lose.<br><strong>Preise gängiger FW-Fahrzeuge (2026 brutto):</strong> KdoW 70.000 € · HLF 20 700.000 € · DLK 900.000 € · RW 700.000 € · RTW 400.000 €<br>→ HLF, DLK, RW liegen stets über dem Schwellenwert → <strong>EU-weites offenes Verfahren ist der Regelfall.</strong>'},
  {id:'h110',cat:'FeuAK · Beschaffungspraxis',q:'Welche 7 Vergabegrundsätze (§97 GWB) sind die „roten Fäden" des Vergaberechts?',a:'1. <strong>Wettbewerbsgrundsatz</strong> – primär öffentliche Ausschreibung; Wettbewerb aktiv fördern.<br>2. <strong>Transparenzgebot</strong> – Zuschlagskriterien vorab veröffentlichen; keine willkürliche Vergabe.<br>3. <strong>Gleichbehandlung</strong> – alle Bieter gleich behandeln (Bieterkommunikation).<br>4. <strong>Wirtschaftlichkeit</strong> – bestes Preis-Leistungs-Verhältnis (§127 GWB).<br>5. <strong>Verhältnismäßigkeit</strong> – Kriterien angemessen zum Auftragsgegenstand (§122, 127 GWB).<br>6. <strong>Mittelstandsschutz</strong> – Losbildungspflicht (§97 Abs. 4 GWB).<br>7. <strong>Strategische Ziele</strong> – Nachhaltigkeit, Mindestlohn, Innovationsförderung.'},
  {id:'h111',cat:'FeuAK · Beschaffungspraxis',q:'Welche 5 Vergabeverfahrensarten gibt es oberhalb der EU-Schwellenwerte (§119 GWB) und wie läuft die Angebotswertung ab?',a:'<strong>Verfahrensarten:</strong><br>1. Offenes Verfahren – Regelfall FW-Fahrzeuge; alle Bieter können Angebot abgeben.<br>2. Nicht offenes Verfahren – nur vorab ausgewählte Bieter.<br>3. Verhandlungsverfahren (mit/ohne Teilnahmewettbewerb).<br>4. Wettbewerblicher Dialog – besonders komplexe Aufträge.<br>5. Innovationspartnerschaft – Entwicklung & Kauf in einem Verfahren.<br><strong>Angebotswertung – 4 Stufen:</strong><br>1. Formale Prüfung (Vollständigkeit, Fristen) → 2. Eignungsprüfung (Fachkunde, Leistungsfähigkeit) → 3. Angemessener Preis → 4. Wirtschaftlichstes Angebot (MEAT).'},
  {id:'h112',cat:'FeuAK · Beschaffungspraxis',q:'Was ist das „Herzstück" der Vergabeunterlagen und wie ist die DIN 14530-27 für das HLF 20 aufgebaut?',a:'<strong>Leistungsbeschreibung</strong> = Herzstück der Vertragsunterlagen (§29 VgV: Anschreiben + Bewerbungsbedingungen + Vertragsunterlagen).<br><strong>Projektteam:</strong> Projektleitung · Fahrzeugtechnik · Einsatzerfahrung · Gerätewart/Werkstatt.<br><strong>DIN 14530-27 (HLF 20, 11/2019):</strong> 1. Maße/Masse · 2. Allg. Anforderungen · 3. Fahrgestell · 4. Fahrer-/Mannschaftsraum · 5. Aufbau · 6. Dach · 7. Löschtechn. Einrichtungen · 8. Techn. Einrichtungen (Funk, Navigation) · 9. Farbgebung · 10. FW-techn. Beladung.<br><strong>Pflichtangaben:</strong> DIN EN 1846 (Teile 1–3) und DIN SPEC 14502-2 müssen benannt werden.<br>Zuschlagskriterien und Gewichtung müssen in der Auftragsbekanntmachung veröffentlicht sein (Transparenzgebot).'},
  {id:'h113',cat:'FeuAK · Beschaffungspraxis',q:'Was besagt die Losbildungspflicht und wann ist eine Blockbeschaffung aus Rahmenverträgen sinnvoll?',a:'<strong>Losbildung (§97 Abs. 4 GWB):</strong> Leistungen sind aufgeteilt zu vergeben – Teillose (Menge) und Fachlose (Art). Bei FW-Fahrzeugen: Los 1 Fahrgestell · Los 2 FW-techn. Aufbau · Los 3 Beladung. Zusammenfassung zulässig bei tech./wirtschaftlichen Gründen (Schnittstellenproblematik).<br><strong>Blockbeschaffung (Rahmenvertrag bis 4 Jahre):</strong><br>Vorteile: einheitliche Ausbildung/Wartung, günstigere Preise (Stückzahleffekte), einfachere Ersatzteilhaltung.<br>Risiko: Baumängel oder Konstruktionsfehler betreffen die gesamte Charge.<br>Ausschreibung durch zentrale Vergabestelle (ZVST); Lieferzeiten stehen erst nach Zuschlag fest.'},
  {id:'h114',cat:'FeuAK · Beschaffungspraxis',q:'Welche 3 Abnahmearten gibt es bei der Fahrzeugbeschaffung und was ist bei der Endabnahme zu beachten?',a:'1. <strong>Konstruktionsgespräch/Auftragsklärung</strong> – nach Zuschlag; AN legt Pläne vor (mind. 1 Woche vorher); Sonderwünsche danach nur noch in geringem Umfang zulässig (§132 GWB).<br>2. <strong>Zwischenabnahme/Rohbauabnahme</strong> – Fahrgestellabnahme bei Übergabe an Aufbauer; erste prakt. Überprüfung; noch Korrekturen möglich. ⚠️ Teilabnahmen starten Gewährleistungsfrist!<br>3. <strong>Endabnahme</strong> – löst Zahlungspflicht aus; unabh. Prüfstelle einbinden (DIN EN 1846-2 komplex). Team 4–6 Personen: Fahrzeug entladen, Beladung prüfen, achsweise wiegen; alle Mängel dokumentieren (Fotos). Fahrzeugeinweisung erst nach mangelfreier Abnahme.'},
  {id:'h115',cat:'FeuAK · Beschaffungspraxis',q:'Wie werden ausgesonderte Feuerwehrfahrzeuge verwertet und was ist dabei rechtlich zu beachten?',a:'Ersetzte Fahrzeuge sind kommunale Vermögenswerte – höchstmöglicher Erlös anzustreben (Wirtschaftlichkeitsprinzip).<br><strong>Verwertungswege:</strong><br>· Öffentliche Auktion – selbst organisiert oder über Plattformen (z. B. zoll-auktion.de)<br>· Direktverkauf zu Schätzpreis/Restwertgutachten an andere Kommune → <strong>Ratsbeschluss erforderlich!</strong><br>· Spende als humanitäre Hilfe (Ukraine, Partnerstädte) → <strong>Ratsbeschluss erforderlich!</strong><br>· Ertüchtigung als Reserve fahrzeug als Alternative zur Aussonderung.'},
  {id:'h116',cat:'FeuAK · Beschaffungspraxis',q:'Was darf und muss bei der Markterkundung (§28 VgV) beachtet werden, und wie werden Preissteigerungen eingeplant?',a:'<strong>Markterkundung (§28 VgV):</strong> Vor Einleitung des Verfahrens erlaubt; nicht zulässig: Verfahren nur zur Marktpreisermittlung.<br>Erlaubt: FW-Besuche mit vergleichbaren Fahrzeugen, unverbindl. Angebotseinholung, Messen, Interessentenkonferenzen, Internet-Recherche.<br>Pflichten: Neutralität, gleiche Informationen für alle Bieter, Dokumentation; beim Bietergespräch klar als Markterkundung kennzeichnen.<br><strong>Preissteigerungsreserve:</strong> Zwischen Ausschreibung und Auslieferung: 12–24 Monate. 2020–2024 Preissteigerungen bis zu 35 %. → Preissteigerungsraten vorsorglich in Haushaltsplanung einrechnen.'},
  {id:'h117',cat:'FeuAK · Beschaffungspraxis',q:'Welche Lebenszykluskosten fallen bei Feuerwehrfahrzeugen an und warum sind sie haushalterisch relevant?',a:'<strong>Laufende Kosten:</strong> Jährliche Inspektionen (Fahrgestell & Aufbau) · Kraftstoff/AdBlue/Strom (eHLF) · Betriebskosten (Standregeneration, Bewegungsfahrten) · Reparaturkosten (steigen mit Nutzungsdauer) · IuK-Kosten ELW (Software, Patches, Updates) · Windenwartung (RW, HLF) · DLK: 5-Jahres- und 10-Jahres-Wartung.<br><strong>Haushalterische Bedeutung:</strong> In Gewährleistungsjahren gering, steigen danach kontinuierlich. Muss bei Abschreibungsberechnung und mittelfristiger Investitionsplanung berücksichtigt werden.<br>Vergabeunterlagen dürfen erst veröffentlicht werden, wenn Haushaltsmittel sicher verfügbar oder Gesamtfinanzierung gesichert ist. Bei mehrjährigen Maßnahmen: Verpflichtungsermächtigung.'},

  {id:'h125',cat:'FeuAK · Beschaffungspraxis',q:'Welche 12 typischen Schadensbilder entstehen bei verzögerter Ersatzbeschaffung?',a:'1. Korrosionsschäden an Fahrzeugrahmen, Hilfsrahmen und Quertraversen<br>2. Risse in der Konstruktion Unterfahrschutz / Haspelbalken<br>3. Risse in der Mannschaftskabine<br>4. Absenkung des Kofferaufbaus<br>5. Risse in der Löschpumpenhalterung und der Hecktraverse<br>6. Korrosion in Radläufen, an Auftritten und Bodengruppen<br>7. Beschädigungen an Fahrerhausverriegelung, C-Säule und Fahrerhaus­boden<br>8. Beschädigungen an Beblechung und Mannschaftsraumtüren<br>9. Fehlende Fahrsicherheitssysteme, unzureichende Abgasreduzierung<br>10. Unzureichende Fahrzeugbeladung<br>11. Unzureichende Ersatzteilversorgung (Laufzeiten FW &gt; Gewerbe → lange Ausfallzeiten)<br>12. Lieferzeiten 2–3,5 Jahre → mehr Reservefahrzeuge nötig → höhere Stellplatz- und Betriebskosten<br><em>Hinweis: Diese Schäden rechtfertigen außerplanmäßige Instandhaltungskosten und sind Kernargument für frühzeitige Beschaffungsplanung.</em>'},
  {id:'h126',cat:'FeuAK · Beschaffungspraxis',q:'Welche 5 Ziele hat ein Fahrzeugbeschaffungsprogramm, und welche Fahrzeuge stellt der Bund für den Katastrophenschutz bereit?',a:'<strong>Ziele eines Fahrzeugbeschaffungsprogramms:</strong><br>1. <strong>Einsatzbereitschaft sichern</strong> – Schutzziel dauerhaft einhalten; Investitionsstau abbauen<br>2. <strong>Aktuelle Motorentechnologie</strong> – unverhältnismäßig hohe Schadstoffemissionen bei Altmotoren vermeiden<br>3. <strong>Moderne Technik &amp; Normerfüllung</strong> – kraftunterstützte Fahrtragen, Leiterentnahmehilfen, Ergonomie<br>4. <strong>Hygiene- &amp; Sicherheitsstandards</strong> – bei Altfahrzeugen wegen fehlender Platzreserven kaum nachrüstbar<br>5. <strong>Attraktivität der Feuerwehr</strong> – zeitgemäße Fahrzeuge und Geräte erhöhen Attraktivität für BF und FF<br><em>Exkurs eHLF:</em> erhebliche Mehrkosten; keine Einsatzwert-Limitierung für Feuerwehr und Polizei, aber Förderbedarf.<br><strong>Zivilschutzausstattung des Bundes</strong> (entlastet kommunale Budgets):<br>· LF 20 KatS, CBRN-ErkW<br>· GW-Dekon-P, MTF-Komponenten<br>· ATF-C, ATF-B<br>→ Bei Gesamtbedarfsplanung berücksichtigen und koordinieren.'},
  {id:'h127',cat:'FeuAK · Beschaffungspraxis',q:'Welche Sonderausstattungen erhöhen die Fahrzeugkosten erheblich, und welche technischen Faktoren begrenzen die zulässige Wattiefe?',a:'<strong>Besondere Ausstattungsmerkmale mit erhöhten Kosten:</strong><br>· Wandlergetriebe (höhere Fahrkomfort- und Einsatzbelastbarkeit)<br>· Allradantrieb (erhöht Gewicht und Kosten signifikant)<br>· Wasserdurchfahrtsfähigkeit / Watausrüstung (technisch aufwändige Abdichtungen)<br>· Folierungen (Stadtdesign, Schutzdesign, Reflektorstreifen)<br>· Sonderbeleuchtung (erweiterte Heckwarnanlagen, Blaulichtbalken Sonderbauform)<br>· Herstellerspezifische Designkonzepte<br><strong>Technische Faktoren der Wattiefe</strong> (bestimmen zulässige Wassertiefe):<br>· Luftansaugung Motor &amp; Kompressor (Lage/Höhe)<br>· Bremsen (Korrosionsschutz, Trockenlaufeignung)<br>· Lenkhydraulik (Dichtigkeit)<br>· Lichtmaschine &amp; Elektrik (Schutzart IP)<br>· Batterie (Einbaulage, Schutzkasten)<br>· Aggregatentlüftungen (Diff, Getriebe)<br>· Auspuff/Abgasanlage (Rückstauventile)<br>· Abdichtung des Fahrzeuginnenraums<br>· Hochvoltbatterie eHLF (erhöhte Anforderungen an Wasserdichtigkeit)'},
  {id:'h128',cat:'FeuAK · Beschaffungspraxis',q:'Wie läuft ein offenes Vergabeverfahren für Feuerwehrfahrzeuge ab (7 Schritte) und welche Vertragsklauseln zu Verzug und Mängeln sind vorzusehen?',a:'<strong>Ablauf offenes Verfahren:</strong><br>1. <strong>Auftragsbekanntmachung</strong> – EU-weit in TED (Supplement zum Amtsblatt der EU); gleichzeitig national<br>2. <strong>Bereitstellung Vergabeunterlagen</strong> – über e-Vergabe-Plattform; Rückfragen an alle Bieter gleichzeitig<br>3. <strong>Angebotsfrist</strong> – mind. 35 Tage ab Bekanntmachung (§15 VgV)<br>4. <strong>Angebotsöffnung &amp; formale Prüfung</strong> – keine öffentliche Öffnung; formale Vollständigkeit<br>5. <strong>Eignungs- &amp; Angebotswertung</strong> – vierstufige Prüfung (formal → Eignung → Preis → wirtschaftlichstes Angebot)<br>6. <strong>Bieterinformation (§134 GWB)</strong> – Mitteilung an nicht berücksichtigte Bieter mit 15-Tage-Wartefrist<br>7. <strong>Zuschlag (§127 GWB / §58 VgV)</strong> – Vertragsschluss mit dem wirtschaftlichsten Angebot<br><strong>Vertragsstrafe &amp; Gewährleistung:</strong><br>· Vertragsstrafe bei Lieferverzug: 0,2–0,5 % Auftragswert je Werktag, max. 5–10 %<br>· Gewährleistungsfrist: mind. 2 Jahre, sicherheitsrelevante Baugruppen häufig 3–5 Jahre<br>· Garantieansprüche vertraglich von gesetzlicher Gewährleistung (BGB) trennen'},
  {id:'h129',cat:'FeuAK · Beschaffungspraxis',q:'Was umfassen Inbetriebnahme, Presse-/Medienarbeit, abschließende Projektdokumentation und nachträgliche Mängelabarbeitung?',a:'<strong>Am Technik-Standort nach Anlieferung:</strong> finale Mängelbehebung · Geräteprüfung · Funkgeräte-/UDS-Einbau · ergänzende Beladung · Inventarisierung (z. B. COSware)<br><strong>Übergabe an Einsatzdienst:</strong> IST/SOLL-Dokumentation · Beladeliste · Multiplikatorenschulung · Beklebung (Wachen-/Wehrwappen) · Flottenmanagement<br><strong>Presse- &amp; Medienarbeit:</strong><br>· Pressemitteilung mit Fahrzeugdaten, Kosten, Fördermittelanteil<br>· Pressetermin mit Amtsleitung, Politik, Fördermittelgebern<br>· Social Media (Instagram, Facebook); interne Kommunikation an alle Wachen<br><strong>Abschließende Projektdokumentation:</strong><br>· Vollständige Ablage: LB, Vergabeakte, Vertrag, Abnahmeprotokolle, Rechnungen, Fotos<br>· Abschlussbericht mit Lessons Learned + Kosten-Controlling (Plan vs. Ist)<br><strong>Nachträgliche Mängelabarbeitung:</strong><br>· Mängel innerhalb Gewährleistungsfrist sofort schriftlich beim Hersteller anzeigen<br>· Garantiearbeiten mit minimaler Fahrzeugausfallzeit koordinieren; alle Einsätze dokumentieren<br>· Abschlussbegehung nach Ablauf der Gewährleistungsfrist empfohlen'},

  {id:'h130',cat:'FeuAK · Beschaffungspraxis',q:'Welche aktuellen Herausforderungen prägen die öffentliche Vergabe, und wie ist der Anwendungsbereich des Vergaberechts (§98–105 GWB) abgegrenzt?',a:'<strong>Herausforderungen (Reinstorf 2026):</strong><br>· <strong>Bietermangel</strong> – rückläufige Wettbewerbsintensität trotz EU-Binnenmarkt<br>· EU-Rechnungshof, Sonderbericht 28/2023: „<strong>verlorenes Jahrzehnt</strong>" – kein Wettbewerbszuwachs in 10 Jahren<br>· Politisches Ziel (Koalitionsvertrag 2025): „einfacher, digitaler, schneller"<br><strong>Anwendungsbereich §98–105 GWB:</strong><br>Persönlich – <em>wer</em> ist gebunden?<br>· §99 GWB: <strong>Öffentlicher Auftraggeber</strong> (Bund, Länder, Kommunen, Körperschaften öR)<br>· §100 GWB: <strong>Sektorenauftraggeber</strong> (Energie, Wasser, Verkehr, Post)<br>· §101 GWB: <strong>Konzessionsgeber</strong><br>Sachlich – <em>was</em> wird beschafft?<br>· §103 GWB: <strong>Öffentlicher Auftrag</strong> = Liefer- / Bau- / Dienstleistungsauftrag<br>· §105 GWB: <strong>Konzession</strong> = Bauleistungs- oder Dienstleistungskonzession'},
  {id:'h131',cat:'FeuAK · Beschaffungspraxis',q:'Wer sind die Teilnehmer am Vergabeverfahren und was gilt für Bietergemeinschaften?',a:'<strong>Bewerber</strong> – Unternehmen in der Phase des <em>Teilnahmewettbewerbs</em> (vor Angebotsabgabe).<br><strong>Bieter</strong> – Unternehmen <em>ab dem Zeitpunkt der Angebotsabgabe</em>.<br><strong>Einzelbewerber/-bieter</strong> – ein Unternehmen allein.<br><strong>Bietergemeinschaft (§43 VgV)</strong> – mehrere Unternehmen gemeinsam; Merkmale:<br>· Zustimmungserfordernis aller Mitglieder<br>· Gesamtschuldnerische Haftung<br>· Auftraggeber kann Umwandlung in bestimmte Gesellschaftsform nach Zuschlag verlangen<br>· ⚠️ Kartellrechtlich problematisch, wenn Mitglieder jeweils allein bietfähig wären<br><strong>Unterauftragnehmer</strong> – Dritte, die Teile der Leistung erbringen; müssen ggf. im Angebot benannt werden.'},
  {id:'h132',cat:'FeuAK · Beschaffungspraxis',q:'Was ist der Digitale Marktplatz Deutschland und welche KI-Anwendungsfälle gibt es bei der öffentlichen Vergabe?',a:'<strong>Digitaler Marktplatz Deutschland (M150, Koalitionsvertrag 2025):</strong><br>· Gemeinsame Vergabeplattform von Bund und Ländern – bereitgestellt bis <strong>31.12.2027</strong><br>· Konsolidiert bestehende E-Vergabeplattformen; datenbasiert, vernetzt, KI-gestützt<br>· Once-Only-Grundsatz: Unternehmen geben Daten nur einmal an<br><strong>KI-Einsatz bei Vergaben (M151):</strong> Erprobung bis 31.12.2026<br><strong>KI-Anwendungsfälle:</strong><br>· Für Unternehmen: intelligentes Matching mit laufenden Verfahren; automatische Vollständigkeitsprüfung von Angeboten<br>· Für Vergabestellen: Agent für Vergabeunterlagen (Wirtschaftlichkeitsbetrachtungen, Einkaufsstrategien); Agent für Vergabedurchführung (Bieterfragen, Angebotsbewertung)<br><strong>Praxisrelevanz FW:</strong> Perspektivisch werden Fahrzeugbeschaffungen über den Marktplatz abgewickelt; einheitliche Formulare, beschleunigte Eignungsnachweise.'},
  {id:'h133',cat:'FeuAK · Beschaffungspraxis',q:'Welche 5 strategischen Handlungsfelder des Warengruppenmanagements (WGM) sind für die Beschaffung relevant?',a:'Das WGM denkt nicht in Einzelvergaben, sondern in Warengruppen über den gesamten Beschaffungsprozess.<br><br>1. <strong>Wettbewerb stärken</strong><br>· Marktgerechte Leistungsbeschreibungen &amp; lösungsoffene Zuschlagskriterien<br>· Teilnahmehürden senken; Ausschreibungen aktiv bewerben<br>· Marktfeedback nach Vergabe systematisch einholen und auswerten<br><br>2. <strong>Standardisierung</strong><br>· Mustervorlagen für Leistungsbeschreibungen und Vertragsklauseln<br>· Messbare Qualitätskriterien definieren; Vergabeprozesse verschlanken<br><br>3. <strong>Dienstleistersteuerung</strong><br>· SLAs, Zielvereinbarungen, Meilensteinberichte<br>· Regelmäßige Feedbackgespräche; strukturiertes Leistungscontrolling<br><br>4. <strong>Qualität sichern / Abhängigkeiten vermeiden</strong><br>· Leistungs-KPIs vertraglich verankern<br>· Exit-Strategien vereinbaren; Lock-in-Effekte vermeiden<br><br>5. <strong>Know-how-Transfer</strong><br>· Dienstleister verpflichten, Wissen aktiv zu übertragen<br>· Lessons-Learned-Workshops; internen Wissenspool aufbauen'},

  /* ── FeuAK – Stakeholder-Analyse ── */
  {id:'h118',cat:'FeuAK · Stakeholder',q:'Welche 4 Schritte umfasst die Stakeholderanalyse und was ist jeweils das Ziel?',a:'1. <strong>Identifikation</strong> – alle relevanten Stakeholder erfassen (intern: Mitarbeitende, Personalrat, Führung; extern: Politik, Bürger, Medien, Auftraggeber, Kooperationspartner).<br>2. <strong>Analyse</strong> – Interessen, Einfluss, Betroffenheit und Erwartungen je Stakeholder ermitteln.<br>3. <strong>Bewertung & Priorisierung</strong> – Tools: Power-Interest-Matrix (Mendelow), Salience-Modell (Mitchell). Einstufung bestimmt den Kommunikationsaufwand.<br>4. <strong>Maßnahmenplanung</strong> – Kommunikations- und Einbeziehungsstrategie ableiten; in Projektplanung und Meilensteinplan integrieren.'},
  {id:'h119',cat:'FeuAK · Stakeholder',q:'Wie funktioniert die Power-Interest-Matrix nach Mendelow und welche 4 Strategien leiten sich ab?',a:'<strong>2×2-Matrix</strong> mit Achsen Macht (Power) × Interesse (Interest):<br><strong>Hohe Macht / Hohes Interesse</strong> → „Manage closely" – eng einbinden, regelmäßig informieren (z. B. Innensenator, Bürgermeister bei Wachenneubauten).<br><strong>Hohe Macht / Geringes Interesse</strong> → „Keep satisfied" – zufriedenstellen, nicht überinformieren (z. B. Stadtrat).<br><strong>Geringe Macht / Hohes Interesse</strong> → „Keep informed" – regelmäßig informieren (z. B. Feuerwehrverein, Verbände).<br><strong>Geringe Macht / Geringes Interesse</strong> → „Monitor" – nur beobachten.<br>Anwendung FW: Kommunikationsplanung bei Dienstplanänderung, Wachenneubauten, Fahrzeugkonzeptionen.'},
  {id:'h120',cat:'FeuAK · Stakeholder',q:'Was ist das Salience-Modell (Mitchell, Agle & Wood 1997) und welche 3 Attribute bestimmen die Stakeholder-Relevanz?',a:'<strong>Salience</strong> (Relevanz) ergibt sich aus 3 Attributen:<br>1. <strong>Power</strong> – Fähigkeit, die Organisation zu beeinflussen.<br>2. <strong>Legitimacy</strong> – gesellschaftlich anerkannter Anspruch (rechtlich, moralisch, sozial).<br>3. <strong>Urgency</strong> – zeitliche Dringlichkeit des Anspruchs.<br><strong>Stakeholder-Typen:</strong> 1 Attribut = Latente (schlafend/diskretionär/anfordernd) · 2 Attribute = Erwartende (dominant/gefährlich/abhängig) · 3 Attribute = <strong>Definitive Stakeholder</strong> → höchste Aufmerksamkeit.<br>Vorteil gg. Mendelow: dynamischer; bildet temporäre Koalitionen und Dringlichkeit ab.'},
  {id:'h121',cat:'FeuAK · Stakeholder',q:'Welche Kommunikationsstrategien gibt es im Stakeholdermanagement und worauf ist bei der Feuerwehr besonders zu achten?',a:'<strong>Beteiligungsstufen</strong> (zunehmend): Informieren → Konsultieren → Einbeziehen → Kooperieren → Empowern.<br><strong>Feuerwehrspezifisch:</strong><br>· Interne Stakeholder (Personalrat, Gewerkschaft, Wachführung): frühzeitig einbinden bei Dienstplan-, Ausrüstungs- oder Konzeptänderungen.<br>· Externe Stakeholder (Medien, Politik): Medien bei Einsatzlagen proaktiv steuern; Politik kontinuierlich über Bedarfsplanung informieren (BSP, Investitionsprogramm).<br>· Dokumentation: Stakeholder-Register führen (Interessen, Maßnahmen, Zeitplan) – Grundlage für Projektevaluation und Rechnungsprüfung.'},

  /* ── FeuAK – Risikoanalyse ── */
  {id:'h122',cat:'FeuAK · Risikoanalyse',q:'Wie werden Risiken bewertet und wie funktioniert die Risikomatrix?',a:'<strong>Risikopotenzial</strong> = Eintrittswahrscheinlichkeit × Schadensausmaß (qualitativ oder quantitativ).<br><strong>Risikomatrix (2D):</strong> X-Achse: Schadensausmaß (gering → katastrophal) · Y-Achse: Eintrittswahrscheinlichkeit (selten → häufig).<br>Felder: 🔴 Rot = hohes Risiko → sofortiger Handlungsbedarf · 🟡 Gelb = mittleres Risiko → Maßnahmen planen · 🟢 Grün = geringes Risiko → akzeptieren/beobachten.<br>Hinweis: Subjektive Experteneinschätzung häufig nötig (objektive Daten selten). Risiken stets einzeln UND als Gesamtportfolio bewerten.<br>Indikatoren gewichten: z. B. Einsatzzahlen, Ausfallzeiten, Kostenentwicklung, Personalstand.'},
  {id:'h123',cat:'FeuAK · Risikoanalyse',q:'Wie wird die Wertkette nach Porter auf die Feuerwehr übertragen und wozu dient sie in der Risikoanalyse?',a:'<strong>Porter\'s Wertkette:</strong> Primäre Aktivitäten (wertschöpfend) + Unterstützende Aktivitäten.<br><strong>Feuerwehr-Übertragung:</strong><br>Primär: Eingangslogistik (Beschaffung Ausrüstung) · Betrieb (Brandbekämpfung, Rettung, Prävention) · Ausgangslogistik (Einsatznachsorge, Dokumentation) · Öffentlichkeitsarbeit · Service (Nachsorge, KNA).<br>Unterstützend: Infrastruktur (Gebäude, Fahrzeuge) · Personalwirtschaft · Technologieentwicklung (Digitalfunk, eHLF) · Beschaffung.<br><strong>Nutzen in der Risikoanalyse:</strong> Identifiziert, in welchen Prozessschritten Risiken entstehen und wo Maßnahmen die größte Wirkung haben (prospektiv).'},
  {id:'h124',cat:'FeuAK · Risikoanalyse',q:'Welche 4 Risikobewältigungsstrategien gibt es und wann werden sie eingesetzt?',a:'1. <strong>Risikovermeidung</strong> – riskante Aktivität unterlassen (z. B. kein Einstieg in einsturzgefährdete Gebäude ohne Statiker).<br>2. <strong>Risikominderung/Reduktion</strong> – Wahrscheinlichkeit oder Schadensausmaß verringern (z. B. regelmäßige Wartung, Ausbildung, PSA).<br>3. <strong>Risikoübertragung</strong> – Risiko auf Dritte verlagern (z. B. Versicherung, Auftragnehmer bei Werkverträgen).<br>4. <strong>Risikoakzeptanz</strong> – bewusstes Eingehen bei sehr geringer Wahrscheinlichkeit oder unvertretbar hohen Vermeidungskosten.<br><em>Prüfreihenfolge: stets VERMEIDUNG → MINDERUNG → ÜBERTRAGUNG → AKZEPTANZ.</em>'},
...
const FEUAK_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:4,nr:'Frage 4',punkte:4,cat:'BSC / QM',
    ...
    {id:6,nr:'Frage 6',punkte:4,cat:'BSC / QM',
    ...
    {id:7,nr:'Frage 7',punkte:6,cat:'BSC / QM',
    ...
    {id:8,nr:'Frage 8',punkte:4,cat:'Vergabe',
    ...
    {id:9,nr:'Frage 9',punkte:3,cat:'Vergabe',
    ...
    {id:10,nr:'Frage 10',punkte:6,cat:'Bedarfsplanung',
    ...
    {id:12,nr:'Frage 12',punkte:6,cat:'Bedarfsplanung',
    ...
    {id:14,nr:'Frage 14',punkte:6,cat:'Bedarfsplanung',
    ...
    {id:18,nr:'Frage 18',punkte:3,cat:'VWL',
    ...
    {id:19,nr:'Frage 19',punkte:7,cat:'Rechnungswesen',
    ...
    {id:20,nr:'Frage 20',punkte:3,cat:'Rechnungswesen',
...
const EINGRENZUNG_QUIZ = (function(){
  ...
  const QUESTIONS = [
    {id:1,nr:'Frage 1',punkte:7,cat:'Haushalt',
     text:'Auf welche Besonderheiten des Haushaltswesens muss sich jede Führungskraft der Feuerwehr einstellen?',
     answer:'<strong>1. Der lange Weg zum Haushalt (F 22)</strong><br>Anmeldungen auf Abteilungsebene (Ergebnishaushalt, Investitionsprogramm, Stellenplan) → Beratung und Anpassung durch Parlamente → Genehmigung durch Aufsichtsbehörden → Veröffentlichung. <strong>Gesamtdauer bis zu 18 Monate.</strong><br><br><strong>2. Konsequenzen für die Feuerwehr (F 23)</strong><br>→ Sehr lange Vorlaufzeit bis zur Rechtskraft → <strong>langfristige, strategische Planung</strong> ist zwingend.<br>→ Haushalte gelten immer nur für <strong>ein Jahr</strong> (Doppelhaushalt = zwei getrennte Haushalte, zum selben Zeitpunkt beschlossen).<br>→ Haushalte können <strong>ausschließlich von Parlamenten</strong> beschlossen und geändert werden – keine Eigenentscheidung der FW.<br><br><strong>3. Feuerwehrspezifische Konflikte (F 27)</strong><br>→ Das Gebot des <strong>schnellen Handelns</strong> passt nicht ins normale Verwaltungsdenken.<br>→ Der Sicherstellungsauftrag bedingt <strong>Flexibilität im Haushaltsvollzug</strong>.<br>→ Bei Beschaffungen ist <strong>strategischer Weitblick</strong> unerlässlich (Investitionsprogramm, Nutzungsdauer, Reservevorhaltung).<br><br><strong>4. Vergaberecht als „Falle" (F 28)</strong><br>→ Schnell im Europarecht und den Schwellenwerten; <strong>keine Vergabe ohne bereitstehende Haushaltsmittel.</strong><br>→ Rechtsstreitrisiko bei Vergabefehlern. Gegenmittel: Rahmenverträge, ausreichende technische Reserve, langfristige Planung.<br><br><strong>5. Steuerungsauftrag (F 19, 46)</strong><br>→ Die Führungskraft muss der Politik die <strong>Strukturen vorgeben</strong>, die sie verhandeln will – die Politik erwartet Vorschläge.<br>→ Beide Ebenen bespielen: strategisch (Haushalt als Vertrag mit der Politik) und operativ (KLR, internes Controlling).'},
    {id:2,nr:'Frage 2',punkte:4,cat:'Haushalt',
     text:'Was können wir uns als Feuerwehr erlauben, wenn wir noch keinen rechtskräftigen Haushalt haben? Was ist zulässig, was ist nicht zulässig? (Thema: vorläufige Haushaltsführung)',
     answer:'Die <strong>vorläufige Haushaltsführung</strong> gilt, solange kein rechtskräftiger Haushalt beschlossen ist.<br><br><strong>Zulässig für die Feuerwehr (F 24):</strong><br>① Ausgaben, zu denen die FW <strong>rechtlich verpflichtet</strong> ist: Löhne und Gehälter, Verträge bedienen, Brandschutz und Rettungsdienst im Rahmen der Bedarfspläne sicherstellen.<br>② Ausgaben, die zur <strong>Aufrechterhaltung des Dienstbetriebes</strong> zwingend notwendig sind: Kraftstoff, Büromaterial, laufender Unterhalt.<br><br><strong>Zulässig allgemein (F 25):</strong><br>③ Ausgaben zur <strong>Vermeidung von Folgeschäden</strong> oder höheren Folgekosten.<br>④ <strong>Fortführung begonnener Investitionen.</strong><br>⑤ Einnahmen in beliebiger Höhe erzielen.<br>→ Fazit: Mit Ausnahme freiwilliger Leistungen faktisch <strong>keine Einschränkungen für den laufenden Dienstbetrieb.</strong><br><br><strong>Nicht zulässig (F 26):</strong><br>① Ausgaben, die nicht unter die oben genannten Kategorien fallen.<br>② <strong>Beginn neuer, im Umfang erheblicher Investitionsmaßnahmen</strong> (Definition i.d.R. in der Haushaltssatzung).<br>③ <strong>Besetzung neuer Stellen</strong> aus einem noch nicht rechtskräftigen Stellenplan.<br><br><em>Ergänzend (F 28): Ohne verfügbare Haushaltsmittel keine Vergabe → die Zeit nutzen, um Vergabeunterlagen (Leistungsverzeichnisse) vorzubereiten.</em>'},
    {id:3,nr:'Frage 3',punkte:6,cat:'BSC / QM',
     text:'Nennen Sie aus zwei typischen Bereichen der Feuerwehr jeweils beispielhaft die wesentlichen Produkte und bestimmen Sie die Kunden / Beteiligten. (Hinweis: entspricht der Fragestellung der Gruppenarbeit; Antwortbasis: Teil 2 der Vorlesung)',
     answer:'<strong>Vorgehensweise (F 98):</strong> Produkte bestimmen → Beteiligte benennen → mindestens eine Qualität aus Sicht eines Beteiligten → mindestens einen messbaren Indikator.<br><em style="font-size:.85rem;opacity:.75">Für die Klausur genügen zwei Bereiche – alle acht stehen hier als Lernvorlage.</em><br><br><strong>Bereich 1 – Abwehrender Brandschutz (F 105)</strong><br><u>Produkte:</u> Brandbekämpfung, Technische Hilfeleistung.<br><u>Beteiligte:</u> Bürger, Politik.<br>→ <em>Bürger</em> wollen schnelle Hilfe: Indikator <strong>Hilfsfristerreichungsgrad</strong>, tatsächliche Eintreffzeit, Ausrückezeit.<br>→ <em>Politik</em> will schnelle, aber kostengünstige Hilfe: Indikator <strong>Kosten nach Risikokategorie</strong> im Vergleich zu anderen Feuerwehren.<br><br><strong>Bereich 2 – Leitstelle (F 109)</strong><br><u>Produkte:</u> Annahme und Disposition von Notfällen (Brandschutz, TH, Rettungsdienst).<br><u>Beteiligte:</u> Bürger, Einsatzabteilung, Kostenträger.<br>→ <em>Bürger</em>: Indikator <strong>Quote der innerhalb einer Zeitvorgabe angenommenen Notrufe</strong>; Kompetenz der Disponierung.<br>→ <em>Kostenträger</em>: Indikator <strong>Höhe der Rettungsdienstgebühr</strong>.<br><br><strong>Bereich 3 – Ausbildung (F 102)</strong><br><u>Produkte:</u> Grundausbildung, Spezialausbildung (z. B. Atemschutz, Fahrzeugführer).<br><u>Beteiligte:</u> Mitarbeiter, Amtsleitung, Berufsgenossenschaft (BGU).<br>→ <em>Mitarbeiter</em> wollen bedarfsgerechte, qualitativ hochwertige Ausbildung: Indikator <strong>Ausbildungsquote je Qualifikationsstufe</strong>, Durchfallquote.<br>→ <em>BGU</em> verlangt Einhaltung gesetzlicher Mindestanforderungen: Indikator <strong>Anteil vorschriftsmäßig qualifizierter Einsatzkräfte</strong>.<br><br><strong>Bereich 4 – Fortbildung (F 103)</strong><br><u>Produkte:</u> Pflichtfortbildungen (z. B. Führerschein C, Erste Hilfe), freiwillige Fortbildungsmaßnahmen.<br><u>Beteiligte:</u> Mitarbeiter, Berufsvertretung, Amtsleitung.<br>→ <em>Mitarbeiter</em> wollen individuelle Weiterentwicklung: Indikator <strong>Fortbildungsstunden je Mitarbeiter und Jahr</strong>.<br>→ <em>Amtsleitung</em> will gleichmäßige Qualifikationsverteilung: Indikator <strong>Teilnahmequote an Pflichtfortbildungen</strong>.<br><br><strong>Bereich 5 – Vorbeugender Brandschutz (F 104)</strong><br><u>Produkte:</u> Brandschutztechnische Prüfungen, Beratungen, Brandverhütungsschauen.<br><u>Beteiligte:</u> Bauherren / Architekten, Gewerbebetriebe, Genehmigungsbehörde.<br>→ <em>Bauherren</em> wollen schnelle, verlässliche Bearbeitung: Indikator <strong>durchschnittliche Bearbeitungszeit je Antrag</strong>.<br>→ <em>Genehmigungsbehörde</em> will rechtssichere Stellungnahmen: Indikator <strong>Mängelquote bei Folgeprüfungen</strong>.<br><br><strong>Bereich 6 – Rettungsdienst (F 106)</strong><br><u>Produkte:</u> Notfallrettung, Krankentransport.<br><u>Beteiligte:</u> Patienten, Kostenträger (Krankenkassen), Krankenhäuser.<br>→ <em>Patienten</em> wollen schnelle, kompetente Versorgung: Indikator <strong>Hilfsfristerreichungsgrad Rettungsdienst</strong>, klinisches Ergebnis.<br>→ <em>Kostenträger</em> wollen wirtschaftlichen Betrieb: Indikator <strong>Kosten je Einsatz / Höhe der Rettungsdienstgebühr</strong>.<br><br><strong>Bereich 7 – Technik (F 107)</strong><br><u>Produkte:</u> Fahrzeuginstandhaltung, Atemschutzwerkstatt, technische Infrastruktur.<br><u>Beteiligte:</u> Einsatzabteilung, Amtsleitung, Kämmerei.<br>→ <em>Einsatzabteilung</em> will jederzeit einsatzbereite Fahrzeuge: Indikator <strong>Fahrzeugverfügbarkeit in %</strong>, mittlere Ausfallzeit je Fahrzeug.<br>→ <em>Kämmerei</em> will wirtschaftlichen Betrieb: Indikator <strong>Instandhaltungskosten je Fahrzeug und Jahr</strong>.<br><br><strong>Bereich 8 – IuK (F 108)</strong><br><u>Produkte:</u> Leitstellen-IT, Digitalfunk-Infrastruktur, Einsatzdokumentation.<br><u>Beteiligte:</u> Leitstelle, Einsatzkräfte, übergeordnete Behörden / Leitstellen.<br>→ <em>Leitstelle</em> will störungsfreien Betrieb: Indikator <strong>Systemverfügbarkeit in %</strong> (Ziel: 99,9 %).<br>→ <em>Einsatzkräfte</em> wollen zuverlässige Kommunikation: Indikator <strong>Fehlerrate / Ausfallzeiten Digitalfunk</strong>.'},
    {id:4,nr:'Frage 4',punkte:6,cat:'BSC / QM',
     text:'Aus welchen Blickwinkeln sollte Qualität nach dem Balanced-Scorecard-Ansatz betrachtet werden?\n\nZusatzfrage: Warum ist diese Betrachtung aus verschiedenen Blickwinkeln notwendig und sinnvoll?',
     answer:'<strong>Die drei Blickwinkel (F 93):</strong><br>① <strong>Sicht des Kunden / der Bevölkerung</strong> – Was erwartet die Bevölkerung? Schnelle Hilfe, kompetente Notfallversorgung.<br>② <strong>Sicht der Geschäftsführung / des Magistrats und der Stadtverordnetenversammlung</strong> – Was erwartet die Politik? Wirtschaftlichkeit, Budgettreue, politische Ziele.<br>③ <strong>Sicht der eigenen Organisation</strong> – Was erwarten Mitarbeitende, Berufsvertretung, Amtsleitung? Arbeitssicherheit, Entwicklung, angemessene Ressourcen.<br><br><strong>Warum mehrperspektivisch? (Zusatzfrage)</strong><br>→ Ein Produkt muss an den <strong>Interessen der Abnehmer</strong> orientiert sein (F 43) – dieselbe Leistung hat je Beteiligtem andere Qualitätsansprüche und damit andere Indikatoren (F 100–109): Bürger → Hilfsfrist, Politik → Kosten pro Risikokategorie.<br>→ <strong>Stakeholder unterscheiden sich in Einfluss und Interesse</strong> (F 91): Die 2×2-Matrix zeigt die nötige Umgangsstrategie – hoher Einfluss / hohes Interesse = aktiv managen; hoher Einfluss / geringes Interesse = strategisch informieren, „bei Laune halten" (z.B. Budgetgeber); niedriger Einfluss / hohes Interesse = auf dem Laufenden halten; niedriger Einfluss / geringes Interesse = minimal überwachen. <em>Achtung: Machtverhältnisse ändern sich – regelmäßig überprüfen.</em><br>→ <strong>Zwei Steuerungsebenen</strong> (F 46, 47): Hilfsfristerreichungsgrad im Stadtgebiet = strategisch/politisch; Werte nach Ausrückbereichen oder Dienstgruppen = taktisch/operativ. Beide Ebenen müssen mit passenden Kennzahlen bedient werden.<br>→ <strong>Politische Gremien einbinden</strong> (F 83): Was passiert, wenn Qualität verbessert wird / gleich bleibt / schlechter wird – auf allen Betrachtungsebenen durchdenken und kommunizieren.'},
    {id:5,nr:'Frage 5',punkte:7,cat:'Bedarfsplanung',
     text:'Auf welche Informationen und Kennzahlen würden Sie primär für strategische Personalplanungen und Entscheidungen zugreifen? (Entspricht dem in Teil 3 der Vorlesung bearbeiteten Stoff)',
     answer:'<strong>Grundbegriffe (F 111, 114)</strong><br><em>Funktion</em> = Aufgabe in einem abgrenzbaren Bereich, gesichert für 365/24 h zu erledigen; ein HLF besetzt 6 Funktionen. Jahresbesetztzeit einer Funktion = <strong>8.760 Stunden</strong>. Grundsatz: Stellen erbringen keine Arbeitsleistung – nur physisch anwesende Menschen (F 111).<br><br><strong>Die drei zentralen Kennzahlen (F 115–118)</strong><br>① <strong>Ist-Personalfaktor</strong>: tatsächlicher Personalbedarf der Vergangenheit, um alle Funktionen ohne Mehrarbeit und Außerdienststellung zu besetzen.<br>② <strong>Aktueller Ist-Stellenfaktor</strong>: bereitgestellte Planstellen (Stellenart 01) ÷ zu besetzende Funktionen; Stellenbesetzungsgrad irrelevant.<br>③ <strong>Politisch beschlossener Soll-Stellenfaktor</strong>: Zeitreihenbasis, 100 % Funktionsbesetzung unterstellt, kein MDL, festgelegter Besetzungsgrad (meist ~95 %, F 128).<br><br><strong>Zu erhebende Ausfallgründe (F 123)</strong><br>Krankheit · Urlaub/Sonderurlaub · Aus-/Fortbildung · Verwendung außerhalb Einsatzdienst · Mutterschutz/Elternzeit · Sonstiges. Alle Ausfallzeiten erfassen, nach Steuerungsrelevanz differenzieren.<br><br><strong>Weitere Einflussgrößen</strong><br>→ <strong>Mehrarbeit</strong> (F 124/125): Aufbau erhöht, Abbau verringert den Personalfaktor. Nicht abbaubare Mehrarbeit = Organisationsverschulden (F 120).<br>→ <strong>Transferleistungen</strong> (F 126): Integrationsdienst, Wachpraktikanten, Tagdienst-Kompensationen – verringern den Faktor.<br>→ <strong>Funktionsunterschreitungsstunden</strong> (F 127): erhöhen den Faktor, keine Verrechnung mit Überschreitungen.<br><br><strong>Rechenbeispiel Frankfurt 2023 (F 131)</strong><br>Theoretische JAZ 2.451 h − Urlaub 439 − Krankheit 327 − Aus-/Fortbildung 146 − Verwendung außerhalb 190 − Elternzeit 27 − Sonstiges 39 = 1.283 h; + Transferleistungen 121 + Überstundenabbau 8 = <strong>1.412 h/MA</strong> → Ist-Personalfaktor 8.760 ÷ 1.412 = <strong>6,20</strong>; Ist-Stellenfaktor <strong>5,27</strong>.<br><br><strong>Strategische Nutzung (F 136, 137)</strong><br>Transparenz über tatsächliche Bedarfe; Zeitreihenvergleiche für Trendanalysen; rechtzeitige Risikoerkennung; Argumente für Stellenplanverfahren; Erhebung mind. 1× jährlich. Ggf. getrennte Faktoren für Funktionsgruppen (NotSan, Schlüsselfunktionen).'},
    {id:6,nr:'Frage 6',punkte:8,cat:'Vergabe',
     text:'Wie würden Sie bei der Beschaffung einer neuen HLF-Generation strategisch vorgehen?\n\nBerücksichtigen Sie: (1) richtiger Zeitpunkt, (2) notwendige Voraussetzungen, (3) worauf besonders zu achten ist, (4) Vor- und Nachteile einer Tranche vs. mehrerer Tranchen, (5) Begründung von Nutzungsdauer und technischer Reserve.',
     answer:'<strong>1. Richtiger Zeitpunkt (F 17, 26, 28)</strong><br>Eine Vergabe darf erst angestoßen werden, wenn <strong>Haushaltsmittel bereitstehen</strong> – keine Vergabe ohne verfügbare Mittel. In der vorläufigen Haushaltsführung sind neue, im Umfang erhebliche Investitionen nicht zulässig. Die Zeit vorher nutzen: <strong>Vergabeunterlagen und Leistungsverzeichnisse vorbereiten.</strong><br><br><strong>2. Notwendige Voraussetzungen (F 20, 90)</strong><br>→ Haushaltsmittel rechtskräftig bewilligt.<br>→ Maßnahme im <strong>Investitionsprogramm</strong> hinterlegt (5-Jahres-Darstellung mit Gesamtvolumen und Jahresabflüssen).<br>→ <strong>Wertungsmatrix</strong> mit Ausschreibung veröffentlicht; Preis als Kriterium mit mind. 40 %.<br>→ Fahrzeuge gehören in den <strong>Vermögenshaushalt</strong> und dürfen als einzige über Kredite finanziert werden.<br><br><strong>3. Worauf besonders zu achten ist (F 28, 50, 51)</strong><br>→ <strong>EU-Schwellenwerte</strong> prüfen (Europarechtskonformität), Rechtsstreitrisiko einkalkulieren.<br>→ <strong>Rahmenverträge</strong> nutzen – mehrjährig, erleichtern Beschaffungen enorm.<br>→ Über Budgetierung <strong>feste Jahresraten</strong> ansparen, Übertragbarkeit von Restmitteln sicherstellen.<br><br><strong>4. Eine Tranche vs. mehrere Tranchen (F 51)</strong><br><u>Vorteile einer Tranche:</u> einheitliche Ausbildung, gleiche Ersatzteilvorhaltung, besserer Preis (Skaleneffekte), eine Ausschreibung.<br><u>Nachteil:</u> Systemfehler des Fahrzeugs betreffen die <strong>komplette Beschaffung</strong>.<br><u>Mehrere Tranchen:</u> Risiko gestreut, aber höhere Einzelkosten und getrennte Ausschreibungen.<br><br><strong>5. Nutzungsdauer und technische Reserve (F 7, 39, 41, 107)</strong><br>→ Nutzungsdauer nach <strong>AfA-Tabelle</strong> (Anlageverzeichnis: Anschaffungswert, Restwert, Nutzungsdauer). Die Ergebnisrechnung muss ausgeglichen sein – jeder Vermögensverzehr muss durch Einnahmen erwirtschaftet werden.<br>→ Beispiel Skript: 5 HLF für 2,5 Mio. € bei 10 Jahren Nutzung = <strong>250.000 €/Jahr Aufwand</strong> – exakt so viel wie ein Kindergarten für 10 Mio. € über 40 Jahre. Das Argument „in andere Bereiche fließt mehr" ist daher meist kein gutes Argument.<br>→ Technische Reserve: <strong>ausreichend bemessen</strong>, Begründung über Indikator <em>Fahrzeugverfügbarkeit</em> (Qualitätsanspruch: schnelle Instandsetzung, ausreichende Vorhaltung).'},
    {id:7,nr:'Frage 7',punkte:6,cat:'Vergabe',
     text:'Wie würden Sie eine Entscheidung für einen Vergabevorschlag rechtssicher und zielorientiert – im Sinne von „Was brauche ich tatsächlich, wie bekomme ich eine hohe Qualität?" – treffen und auf was müssen Sie dabei achten? (Thema: Nutzwertanalyse)',
     answer:'<strong>Instrument: Nutzwertanalyse (NWA) (F 88)</strong><br>Entscheidungsverfahren, das mehrere Alternativen anhand <strong>gewichteter qualitativer und quantitativer Kriterien</strong> vergleicht. Für jede Alternative wird ein Gesamtnutzen berechnet – die Alternative mit dem <strong>höchsten Wert ist die rechnerisch beste Wahl</strong>. Bietet eine weitgehend rechtssichere Basis für Vergabeentscheidungen (F 89).<br><br><strong>Beispiel Vergabeentscheidung HLF (F 89)</strong><br><table style="border-collapse:collapse;font-size:.82rem;margin:.5rem 0;width:100%"><thead><tr style="background:rgba(201,168,76,.15)"><th style="padding:.25rem .5rem;text-align:left;border:1px solid rgba(255,255,255,.1)">Kriterium</th><th style="padding:.25rem .5rem;text-align:center;border:1px solid rgba(255,255,255,.1)">Gewicht</th><th style="padding:.25rem .5rem;text-align:center;border:1px solid rgba(255,255,255,.1)">Anbieter A (Punkte)</th><th style="padding:.25rem .5rem;text-align:center;border:1px solid rgba(255,255,255,.1)">A gewichtet</th><th style="padding:.25rem .5rem;text-align:center;border:1px solid rgba(255,255,255,.1)">Anbieter B (Punkte)</th><th style="padding:.25rem .5rem;text-align:center;border:1px solid rgba(255,255,255,.1)">B gewichtet</th></tr></thead><tbody><tr><td style="padding:.2rem .5rem;border:1px solid rgba(255,255,255,.08)">Preis</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">40 %</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">4</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">1,6</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">2</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">0,8</td></tr><tr><td style="padding:.2rem .5rem;border:1px solid rgba(255,255,255,.08)">Unterhaltung</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">30 %</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">3</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">0,9</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">3</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">0,9</td></tr><tr><td style="padding:.2rem .5rem;border:1px solid rgba(255,255,255,.08)">Zuladungsreserve</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">30 %</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">3</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">0,9</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">4</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">1,2</td></tr><tr style="font-weight:700"><td style="padding:.2rem .5rem;border:1px solid rgba(255,255,255,.08)">Gesamtnutzwert</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">100 %</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">—</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08);color:#4ACD90">3,4</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">—</td><td style="text-align:center;border:1px solid rgba(255,255,255,.08)">2,9</td></tr></tbody></table>→ Anbieter A gewinnt mit 3,4 vs. 2,9.<br><br><strong>Rechtliche Pflichten (F 90)</strong><br>① Haushaltsrechtliche Voraussetzungen müssen vor Vergabestart gegeben sein.<br>② <strong>Preis muss mit mind. 40 % gewertet</strong> sein.<br>③ Die <strong>Wertungsmatrix muss mit der Ausschreibung veröffentlicht</strong> und allen Anbietern zugänglich sein.<br><br><strong>Für die Entscheidungsvorlage (F 83, 84, 95)</strong><br>→ Wechselwirkungen für die Gremien darstellen – was passiert bei Verbesserung / Gleichbleiben / Verschlechterung der Qualität?<br>→ Ziele, Maßnahmen, Spielregeln und Ressourcen <strong>schriftlich fixieren</strong>.<br>→ Haltung: Aufgabe ist, Entscheidungen bestmöglich zu treffen – nicht darum herumdrücken, um Misserfolge zu vermeiden.'},
    {id:8,nr:'Frage 8',punkte:6,cat:'BSC / QM',
     text:'Bei welchen zentralen, für die Entwicklung und Schlagkraft der Feuerwehr entscheidenden Planungen werden Risikoanalysen eingesetzt – und warum sind Sie gerade dann auf valide und begründete Argumente angewiesen?\n\n(Themen: Risikoanalyse · Agieren und Interagieren mit den politischen Gremien)',
     answer:'<strong>Risikoanalyse als Planungsinstrument (F 94)</strong><br>Systematischer Prozess zur Identifikation, Bewertung und Steuerung potenzieller Gefahren; Basis für <strong>Bedarfspläne</strong> in Brand- und Katastrophenschutz sowie für strategische Entscheidungen (Beschaffung, Personalplanung, Standortplanung).<br><br><strong>Schritte der Risikoanalyse</strong><br>① <strong>Risikoidentifikation</strong> – alle relevanten Risiken erfassen.<br>② <strong>Risikobewertung</strong> per Risikomatrix: Eintrittswahrscheinlichkeit (1–5) × Schadensausmaß (1–5) = Risikowert (1–25).<br>③ <strong>Maßnahmenplanung</strong>: Risikovermeidung (Ursache eliminieren) oder Risikoverringerung (EW oder Schadenshöhe senken).<br>④ <strong>Risikoüberwachung</strong> als fortlaufender Prozess mit Dokumentation und regelmäßiger Trendprüfung.<br><br><strong>Warum valide Daten entscheidend sind – Datenquellen</strong><br>→ <strong>Verwaltung / Stellen- und Personalmanagement</strong> (F 129, 136): Stellenartennachweis; ohne diese Daten keine belastbare Personalfaktorberechnung.<br>→ <strong>Dezentrale Dienstplankoordination</strong> (F 129): geeignetes elektronisches Programm notwendig.<br>→ <strong>Kosten- und Leistungsrechnung</strong> (F 58): wichtigste Informationsquelle für interne Steuerung, Gebührenkalkulation und Argument gegen Privatisierungen.<br>→ <strong>Brandschutzbedarfs- und Entwicklungsplan (BEP)</strong> (F 87): fachliches Pendant zur mittelfristigen Haushaltsplanung; BEP mit Haushalt verknüpfen; Kennzahl: Abarbeitung der BEP-Maßnahmen in %.<br>→ <strong>Benchmarking</strong> (F 85): Vergleich einheitlicher Kennzahlen, Lernen vom Besten – aber Validität, Strukturunterschiede und Ehrlichkeit der Partner beachten.<br><br><strong>Agieren mit politischen Gremien (F 61, 62, 63, 71, 91, 95)</strong><br>→ <strong>Stakeholder-Mapping</strong>: politische Gremien und Budgetgeber haben hohen Einfluss → aktiv managen.<br>→ <strong>Externes Controlling</strong> für Politik und Amtsleitung: hochaggregiert (Schutzzielerreichungsgrad, Budgetstand). <strong>Internes Controlling</strong> für mittlere Führung: feinteilig nach Bereichen.<br>→ <strong>Offensiv mit dem Status quo umgehen</strong> (F 63): schlechte Ergebnisse zu kaschieren ist fahrlässig und führt dazu, Verantwortung für etwas zu übernehmen, das man nicht verursacht hat.<br>→ <strong>Prozessoptimierung hat immer Vorrang</strong> vor der Forderung nach zusätzlichen Ressourcen (F 71).<br>→ <strong>Valide Kennzahlen über längere Zeitreihen</strong> sind das stärkste Argument (F 95): Bereiche mit belastbarem Datenmaterial sind bei Verteilungskämpfen langfristig im Vorteil – im kommunalen Bereich umso mehr, da Kennzahlensteuerung trotz 40 Jahren NSM noch nicht flächendeckend etabliert ist.'},
  ];
...
const CHANGELOG=(function(){
  ...
  const ENTRIES=[
    {v:'2.29.0',ts:'2026-08-20T22:00',items:[
      'Neue Lernkarte h133: Strategische Handlungsfelder des Warengruppenmanagements (WGM) – 5 Felder: Wettbewerb stärken, Standardisierung, Dienstleistersteuerung, Qualität/Abhängigkeiten, Know-how-Transfer'
    ]},
    ...
    {v:'2.27.0',ts:'2026-08-19T16:00',items:[
      'Eingrenzung: Alle 8 Fragen durch echte Dozenten-Klausurfragen aus den offiziellen Klausurhinweisen ersetzt (50 Pkt, zuvor 44 Pkt)',
      'Antworten aus Musterlösung + Vorlesungsfolien (Haushalt, BSC/QM, Bedarfsplanung, Vergabe, Risikoanalyse) synthetisiert',
      'Punktzahl-Anzeige im Klausuren-Hub und in der Eingrenzungsseite auf 50 Pkt korrigiert'
    ]},
    ...
    {v:'2.19.7',ts:'2026-08-11T18:00',items:[
      'Lernkarten PM h78–h94: Reihenfolge an Abschnittsfolge angepasst (Abschnitt 01→02→03→04→05→10) und IDs entsprechend neu nummeriert'
    ]},
    ...
    {v:'2.18.15',ts:'2026-08-10T13:00',items:[
      ...
      '19 VWL-Lernkarten vollständig überarbeitet: 11 bestehende Karten aktualisiert/neu bespielt (h01–h05, h28, h46, h51, h54, h67, h68), 8 neue Karten h70–h77 (Positive Externalität, Ressourcenmanagement, Effizienz vs. Effektivität, Personalökonomie, Skaleneffekte, TCO, KNA, Grenzkosten)',
      'Lernkarten gesamt: 312 → 320'
    ]},
    {v:'2.18.13',ts:'2026-08-07T16:00',items:[
      ...
      'Bug-Fix: Kartenzähler in Lernkarten-Tab, Startseite und Onboarding auf 312 korrigiert (war fälschlicherweise noch 284)'
    ]},
    {v:'2.18.12',ts:'2026-08-07T15:00',items:[
      'FeuAK Altklausur: Punktzahl je Frage neu bewertet – differenzierte Verteilung nach Umfang und Komplexität (3–7 Punkte statt pauschal 5); Gesamtpunktzahl bleibt 110'
    ]},
