...
const FLASHCARD_DATA = [
  ...
  {id:'g78',cat:'GAL · Leitern',q:'Welche Leiterarten kennt die Feuerwehr und was sind ihre Einsatzgrenzen?',a:'<strong>Steckleiter (StL4):</strong> 4 Elemente à 2,65 m, Rettungshöhe ca. 8 m – tragbar, vielseitig.<br><strong>Schiebleiter (3-tlg.):</strong> 14 m Einsatzlänge, Rettungshöhe 12,20 m (3. OG); Tragen und Aufstellen: 4 FA (2 Trupps).<br><strong>Hakenleiter:</strong> Einhängen an Fensterbänken, für Stockwerkverbindung.<br><strong>Drehleiter (DLK 23-12):</strong> bis 23 m Nennrettungshöhe, motorisiert.<br>Prüfung nach DGUV V 49 jährlich.'},
