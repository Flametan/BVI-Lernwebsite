...
const EINGRENZUNG_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:9,nr:'Frage 9',punkte:4,cat:'Vergabe',
     text:'Ab welchem EU-Schwellenwert gilt das europäische Vergaberecht für Kommunen bei Liefer- und Dienstleistungsaufträgen (Stand: 1.1.2026)?\n\nNennen Sie außerdem: den maßgeblichen Zeitpunkt für die Auftragswertschätzung, zwei Feuerwehrfahrzeuge, die stets über dem Schwellenwert liegen, und die Mindestangebotsfrist beim offenen Verfahren.',
     answer:'<strong>EU-Schwellenwert ab 1.1.2026 – Kommunen (§106 GWB):</strong><br>Liefer- und Dienstleistungsaufträge: <strong>216.000 € (netto)</strong><br>Sektorenauftraggeber: 432.000 € · Bauleistungen: 5.404.000 €<br><br><strong>Maßgeblicher Zeitpunkt der Auftragswertschätzung (§3 VgV):</strong><br>Tag der <strong>Auftragsbekanntmachung</strong> (= Einleitung des Vergabeverfahrens); Gesamtwert ohne MwSt., inkl. aller Optionen und Verlängerungen. Bei Blockbeschaffungen: Gesamtwert aller Lose.<br><br><strong>Feuerwehrfahrzeuge stets über dem Schwellenwert:</strong><br>· HLF 20: ca. 700.000 € · DLK: ca. 900.000 € · RW: ca. 700.000 €<br>→ EU-weites <strong>offenes Verfahren</strong> ist der Regelfall.<br><br><strong>Mindestangebotsfrist – offenes Verfahren (§15 VgV):</strong><br>· Standard: mind. <strong>35 Tage</strong> ab EU-Auftragsbekanntmachung (TED – Tenders Electronic Daily)<br>· Bei Vorankündigung / e-Submission: Verkürzung auf 15 Tage möglich<br>· Dringende Fälle: mind. 15 Tage'},
    {id:10,nr:'Frage 10',punkte:5,cat:'Vergabe',
     text:'Nennen Sie die 9 Grundsätze des Vergaberechts (§97 GWB) und geben Sie zu jedem Grundsatz die wesentlichen Stichpunkte an.',
     answer:'Die 9 Grundsätze des Vergaberechts (§97 GWB) durchziehen als <strong>\u201arote Fäden\u2018</strong> das gesamte Vergaberecht:<br><br>1. <strong>Wettbewerbsgrundsatz:</strong> Primär öffentliche Ausschreibung · genaue und bestimmte Festlegung der Zuschlagskriterien → kein willkürlicher Zuschlag möglich<br><br>2. <strong>Transparenzgebot:</strong> Veröffentlichungspflichten in Auftragsbekanntmachung oder Vergabeunterlagen · Bieterkommunikation §7 Abs. 2 VgV · primär öffentliche Ausschreibung<br><br>3. <strong>Grundsatz der Wirtschaftlichkeit:</strong> Zuschlag auf das wirtschaftlichste Angebot = bestes Preis-Leistungs-Verhältnis (§127 GWB)<br><br>4. <strong>Grundsatz der Verhältnismäßigkeit:</strong> Eignungs- und Zuschlagskriterien in angemessenem Verhältnis zum Auftragsgegenstand (§122, §127 GWB) · angemessene Fristsetzung (§20 VgV) · fakultativer Ausschluss nur unter Berücksichtigung der Verhältnismäßigkeit (§124 Abs. 1 GWB)<br><br>5. <strong>Grundsatz der Gleichbehandlung (§97 Abs. 2 GWB):</strong> Alle Teilnehmer gleich behandeln – Ungleichbehandlung nur gesetzlich geboten oder gestattet · einheitliche Bieterkommunikation<br><br>6. <strong>Berücksichtigung strategischer Ziele:</strong> Nachhaltigkeitsaspekte · Innovationsfreundlichkeit · Mindestlohn &amp; sozialverträgliche Beschaffung<br><br>7. <strong>Gebot der Mittelstandsfreundlichkeit:</strong> Grundsätzlich Losaufteilung – Teils- und Fachlose (§97 Abs. 4 GWB) · FW: Los 1 Fahrgestell · Los 2 FW-Aufbau · Los 3 Beladung<br><br>8. <strong>Gebot des Einsatzes elektronischer Mittel:</strong> E-Vergabe ab Oberschwelle Pflicht; perspektivisch Digitaler Marktplatz Deutschland (bis 31.12.2027)<br><br>9. <strong>Rechtsanspruch auf Einhaltung der Vergaberegeln:</strong> Bieter können Verstöße rügen (§160 GWB); Nachprüfungsverfahren vor der Vergabekammer'},
  ];
