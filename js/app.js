...
const EINGRENZUNG_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:10,nr:'Frage 10',punkte:5,cat:'Vergabe',
     ...
     answer:'Die 8 Grundsätze durchziehen als <strong>‚rote Fäden‘</strong> das gesamte Vergaberecht:<br><br>1. <strong>Wirtschaftlichkeit:</strong> Zuschlag auf das wirtschaftlichste Angebot = bestes Preis-Leistungs-Verhältnis (§127 GWB)<br><br>2. <strong>Wettbewerbsgrundsatz:</strong> Primär öffentliche Ausschreibung · genaue und bestimmte Festlegung der Zuschlagskriterien → kein willkürlicher Zuschlag möglich<br><br>3. <strong>Transparenzgebot:</strong> Veröffentlichungspflichten in Auftragsbekanntmachung oder Vergabeunterlagen · Bieterkommunikation §7 Abs. 2 VgV · primär öffentliche Ausschreibung<br><br>4. <strong>Gleichbehandlung (§97 Abs. 2 GWB):</strong> Alle Teilnehmer gleich behandeln – Ungleichbehandlung nur gesetzlich geboten oder gestattet · einheitliche Bieterkommunikation<br><br>5. <strong>Verhältnismäßigkeit:</strong> Eignungs- und Zuschlagskriterien in angemessenem Verhältnis zum Auftragsgegenstand (§122, §127 GWB) · angemessene Fristsetzung (§20 VgV) · fakultativer Ausschluss nur unter Berücksichtigung der Verhältnismäßigkeit (§124 Abs. 1 GWB)<br><br>6. <strong>Berücksichtigung strategischer Ziele:</strong> Mittelstandsschutz → Losvergabe (§97 Abs. 4 GWB) · Nachhaltigkeitsaspekte · Innovationsfreundlichkeit · Mindestlohn &amp; sozialverträgliche Beschaffung<br><br>7. <strong>Gebot des Einsatzes elektronischer Mittel:</strong> E-Vergabe ab Oberschwelle Pflicht; perspektivisch Digitaler Marktplatz Deutschland (bis 31.12.2027)<br><br>8. <strong>Rechtsanspruch auf Einhaltung der Vergaberegeln:</strong> Bieter können Verstöße rügen (§160 GWB); Nachprüfungsverfahren vor der Vergabekammer'},
  ];
