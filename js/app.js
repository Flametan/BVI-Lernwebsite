...
const EINGRENZUNG_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:10,nr:'Frage 10',punkte:5,cat:'Vergabe',
     text:'Nennen Sie die 8 Grundsätze des Vergaberechts (§97 GWB) und erläutern Sie jeden in einem Satz mit Bezug zur Feuerwehr.',
     answer:'1. <strong>Wettbewerbsgrundsatz</strong> – mindestens 3 geeignete Anbieter ansprechen; EU-weite Ausschreibung als Regelfall bei FW-Großfahrzeugen.<br>2. <strong>Transparenzgebot</strong> – Zuschlagskriterien mit Gewichtung vorab im Amtsblatt veröffentlichen; vollständige Vergabeakte führen.<br>3. <strong>Grundsatz der Verhältnismäßigkeit</strong> – Eignungsanforderungen müssen angemessen zum Auftragswert sein (§122, §127 GWB).<br>4. <strong>Grundsatz der Gleichbehandlung</strong> – alle Bieter gleich behandeln; Bieterfragen nur gesammelter, gleichzeitiger Rückantwort an alle.<br>5. <strong>Berücksichtigung strategischer Ziele</strong> – Nachhaltigkeit, Mindestlohn, Innovationsförderung als Zuschlagskriterien zulässig (z. B. eHLF bevorzugen).<br>6. <strong>Gebot der Mittelstandsfreundlichkeit</strong> – Losaufteilung Pflicht (§97 Abs. 4 GWB): z. B. Los 1 Fahrgestell, Los 2 FW-Aufbau, Los 3 Beladung.<br>7. <strong>Gebot des Einsatzes elektronischer Mittel</strong> – E-Vergabe-Plattform ab Oberschwelle Pflicht; perspektivisch Digitaler Marktplatz Deutschland.<br>8. <strong>Rechtsanspruch auf Einhaltung der Vergaberegeln</strong> – Bieter können Vergabeverstöße rügen (§160 GWB); Nachprüfung vor Vergabekammer.'},
  ];
