...
const KF_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:6,nr:'Frage 6',punkte:5,cat:'Bedarfsplanung',
     ...
     answer:'<em>Voraussetzung – Datenbereinigung:</em> Ausschluss von Testeinsätzen, Stornierungen, nicht relevanten Fahrzeugen und Einsätzen mit unplausiblen Statuszeiten (z.B. S4→S7 &lt; 30 Sekunden). Grundsatz: Je Auswertung so viele Einsätze wie möglich heranziehen.<br><br><strong>1. Frequenzanalyse (Einsatzhäufigkeitsanalyse)</strong><br><strong>Langfristige Entwicklung:</strong> Über viele Jahre kontinuierlicher Anstieg der Einsatzzahlen; Corona-Delle 2020; seit Anpassung der Einsatzkonzepte erste Verlangsamung des Anstiegs. Wichtig: Bedarfsplanung erfolgt auf Basis retrospektiver Daten → <strong>Planungsverzug</strong>.<br><strong>Räumliche Verteilung:</strong> Identifikation klarer Einsatzschwerpunkte im Zuständigkeitsgebiet.<br><strong>Zeitliche Verteilung (Tagesgang):</strong> Differenzierung nach Tageskategorien (Mo–Fr / Sa+Feiertag / So); höchstes Aufkommen in den Vormittagsstunden. Im KTW: sprunghafte Anstiege zu Schichtbeginn deuten auf <strong>Angebotsdruck</strong> hin (Nachfrage folgt Angebot).<br><em>Ergebnis:</em> Grundlage für frequenzabhängige Vorhaltungsplanung (KTW) sowie für Schichtplanung und Tageskategorienbemessung (RTW).<br><br><strong>2. Hilfsfristerreichungsanalyse (Versorgungszeitanalyse)</strong><br><strong>Erreichungsgrad:</strong> Auswertung der tatsächlichen Eintreffzeiten im Analysezeitraum; SOLL-IST-Vergleich mit dem gesetzlichen Schutzziel.<br><strong>Räumliche Differenzierung – Gesamterreichung vs. Erreichung ab zuständiger Wache:</strong><br>→ Gute Erreichung ab zuständiger Wache, schlechte Gesamterreichung = <strong>Ressourcenverfügbarkeitsproblem</strong> (zu wenig Fahrzeuge parallel verfügbar).<br>→ Schlechte Erreichung auch ab zuständiger Wache = <strong>Standortproblem</strong> (Erreichbarkeit / Standortstruktur).<br><strong>Problemfeldanalyse:</strong> Mehrstufige Analyse der Verursachungsbeiträge der Nicht-Erreichung (z.B. Standortstruktur/Verkehr · Ausrückzeit · Ressourcenverfügbarkeit). Ermöglicht zielgerichtete Maßnahmenableitung – organisatorische Optimierungen der Ausrückzeit sind in der Regel einfacher und schneller umsetzbar als Standortveränderungen.<br><em>Ergebnis:</em> Identifikation von Versorgungslücken und deren Ursachen → Maßnahmen gezielt am Verursachungsbeitrag ausrichten.',
     short:'<strong>Zweigleisige IST-Analyse RD-Bedarfsplanung:</strong><br><br><strong>① Frequenzanalyse:</strong> Langfristige Entwicklung (Anstieg · Corona-Delle · Verlangsamung durch neue Konzepte); räumliche Schwerpunkte; Tagesgang nach Kategorien (Mo–Fr / Sa+Ft / So); KTW-Angebotsdruck bei Schichtbeginn.<br><em>Ergebnis:</em> Frequenzabhängige Vorhaltungsplanung (KTW); Schichtplanung (RTW).<br><br><strong>② Hilfsfristerreichungsanalyse:</strong> Erreichungsgrad gesamt + räumlich; Gesamterreichung vs. Erreichung ab zuständiger Wache → Unterscheidung Ressourcenverfügbarkeits- vs. Standortproblem; Problemfeldanalyse (Verursachungsbeiträge: Standortstruktur · Ausrückzeit · Ressourcen).<br><em>Ergebnis:</em> Versorgungslücken + Ursachen → zielgerichtete Maßnahmenableitung.'},
