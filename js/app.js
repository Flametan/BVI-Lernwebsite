  ...
  const CASES = [
    ...
    ,
    {
      ...
      answers:[
        ...
        'Kein Adressat für die Kernaßnahme (leere Halle) → Realakt. <strong>Verhaltensstörer (§17 OBG):</strong> Betonmischer-Fahrer/Firma (hat den Balken beschädigt und damit die Gefahr kausal verursacht). <strong>Zustandsstörer (§18 OBG):</strong> Eigentümer der Halle (von seiner Sache geht die Einsturzgefahr aus). Für Kostenersatz und Weiterleitungspflichten relevant; als Adressat einer Ordnungsverfügung der Bauaufsichtsbehörde.',
