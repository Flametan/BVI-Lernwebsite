...
const FLASHCARD_DATA = [
  ...
  {id:'h67b',cat:'FeuAK · Bedarfsplanung',q:'Nennen Sie die drei Ermessensqualitäten in der Bedarfsplanung und ordnen Sie sie ein.',a:'<strong>1. Strukturqualität</strong> (Bedarfsplanung)<br>Schafft die Voraussetzungen: Standorte, Fahrzeuge, Personal, Ausbildung, Technik. Beantwortet die Frage: „Sind die richtigen Ressourcen in ausreichender Menge vorhanden?" Steuerungsinstrument: Brandschutzbedarfsplan (BEP).<br><br><strong>2. Prozessqualität</strong> (am Einsatzort)<br>Bewertet, wie die Einsatzleistung erbracht wird: Taktisches Vorgehen, Führungsverhalten, Kommunikation, Zusammenarbeit. Steuerungsinstrument: Übungen, Einsatznachbereitung, Prozessmanagement (PDCA).<br><br><strong>3. Ergebnisqualität</strong> (Ziele erreicht?)<br>Misst, ob das Schutzziel erreicht wurde: Hilfsfrist eingehalten? Funktionsstärke erreicht? Erreichungsgrad ≥ 90 %? Steuerungsinstrument: Kennzahlen, Hilfsfriststatistik, BSC.'},
  {id:'h67c',cat:'FeuAK · Bedarfsplanung',q:'Wie ist der Brandschutzbedarfsplan (BEP) aufgebaut und wie hängt er mit dem Haushalt zusammen?',a:'<strong>Aufbau des BEP:</strong><br>① <strong>Schutzziele</strong> – politisch festgelegte Mindeststandards (z.B. „10 EK in 8 Min. bei ≥ 90 % der Lagen").<br>② <strong>IST-Analyse</strong> – Risikokataster, Hilfsfristauswertung, Personalfaktorerhebung.<br>③ <strong>SOLL-IST-Vergleich</strong> – wo liegen Lücken zwischen Anspruch und Realität?<br>④ <strong>Maßnahmenplan</strong> – Investitions- und Personalmaßnahmen mit Priorisierung.<br>⑤ <strong>Kennzahl:</strong> BEP-Maßnahmen abgearbeitet in %.<br><br><strong>Verbindung zum Haushalt:</strong> BEP ist das fachliche Pendant zur mittelfristigen Haushaltsplanung. Ohne Haushaltsmittel keine Maßnahmen – ohne BEP kein fachlich begründeter Mitteleinsatz. Fortschreibungsintervall: in der Regel alle 5 Jahre oder bei wesentlichen Änderungen.'},
  {id:'h67d',cat:'FeuAK · Bedarfsplanung',q:'Was ist die Erlang-B-Formel und wofür wird sie in der Rettungsdienstbedarfsplanung eingesetzt?',a:'<strong>Einsatzbereich:</strong> Stochastische Vorhaltungsplanung für <strong>RTW</strong> (Notfallrettung), wo Einsätze nicht planbar sind (Zufallsprozess).<br><br><strong>Grundprinzip (Erlang-B):</strong> Berechnet die Blockierungswahrscheinlichkeit P(B) – also wie oft kein RTW verfügbar ist – in Abhängigkeit von:<br>· <em>A</em> = Angebotene Verkehrsintensität (Einsatzhäufigkeit × mittlere Einsatzdauer)<br>· <em>n</em> = Anzahl vorgehaltener RTW<br><br><strong>Zielgröße:</strong> P(B) &lt; 1–5 % → unter 1–5 % der Notrufe darf kein RTW verfügbar sein.<br><br><strong>Abgrenzung zur KTW-Frequenzkurve:</strong><br>· RTW: stochastisch, Erlang-Formel → risikoabhängige Vorhaltung.<br>· KTW: deterministisch, Frequenzkurve → frequenzabhängige Vorhaltung.'},
  {id:'h67e',cat:'FeuAK · Bedarfsplanung',q:'Wie funktioniert GIS-gestützte Standortplanung in der Bedarfsplanung?',a:'<strong>Ziel:</strong> Optimale Standortwahl für Feuerwehrwachen/Rettungswachen, um Schutzzeiten flächendeckend einzuhalten.<br><br><strong>Instrumente:</strong><br>① <strong>Isochronen</strong> – Gebiete, die innerhalb einer definierten Fahrzeit erreichbar sind (z.B. 8-Minuten-Isochrone). Dargestellt als Einzugsbereiche auf Karte.<br>② <strong>Versorgungslücken-Analyse</strong> – Bereiche außerhalb der Isochrone → Bedarf für neue Standorte oder mobile Vorhaltung.<br>③ <strong>Optimierungsalgorithmen</strong> – Standortsuche, die Abdeckungsgrad maximiert bei gegebenen Kosten.<br><br><strong>Eingangsdaten:</strong> Straßennetz, Geschwindigkeitsprofile, Einsatzschwerpunkte (Heatmap), Bevölkerungsdichte.<br><br><strong>Ergebnis:</strong> Planungsgrundlage für BEP-Maßnahmen; belastbares Argument gegenüber politischen Gremien.'},
  {id:'h67f',cat:'FeuAK · Bedarfsplanung',q:'Wann werden externe Sachverständige in der Bedarfsplanung eingesetzt – und was spricht dafür und dagegen?',a:'<strong>Typische Anlässe:</strong><br>· Erstellung oder Fortschreibung des Brandschutzbedarfsplans (BEP)<br>· Bedarfsplanungen im Rettungsdienst (neutrale Ist-Analyse)<br>· Standortgutachten, Personalbedarfsermittlung<br>· Gerichtliche Auseinandersetzungen über Schutzziele<br><br><strong>Argumente dafür (Pro):</strong><br>✓ Fachliche Neutralität – kein Eigeninteresse<br>✓ Aktuelle Methodik (GIS, Erlang, Benchmarks)<br>✓ Politische Akzeptanz – Gutachten schwerer angreifbar als interne Planung<br>✓ Entlastung des eigenen Personals<br><br><strong>Argumente dagegen (Contra):</strong><br>✗ Kosten (oft 5-stellig)<br>✗ Wissenstransfer bleibt außen (Know-how nicht intern aufgebaut)<br>✗ Ortskenntnis fehlt – lokale Besonderheiten müssen erst vermittelt werden<br>✗ Keine Dauerlösung für laufendes Controlling'},
