...
const FLASHCARD_DATA = [
  ...
  {id:'h67',cat:'FeuAK · VWL',q:'Städtische Haushaltsmittel werden durch den Gesetzgeber gekürzt. Wie wirkt sich das auf den HLF-20-Markt aus?',a:'<strong>Nachfrageseite:</strong> Kommunale Beschaffungsbudgets sinken → Nachfragekurve verschiebt sich nach <strong>links</strong>.<br><strong>Neues Gleichgewicht:</strong> Gleichgewichtspreis sinkt, Gleichgewichtsmenge sinkt (c.p.).<br><strong>Angebotsseite:</strong> Hersteller reduzieren Produktion; schwächere Anbieter könnten aussteigen → Marktkonzentration.<br><strong>Sekundäreffekte:</strong> Beschäftigungsrückgang · geringere Steuereinnahmen · Preisdruck beeinträchtigt Qualität.<br><strong>Besonderheit:</strong> FW-Nachfrage relativ <strong>preisinelastisch</strong> (Pflichtaufgabe), aber volumenmäßig durch Budgetdeckelung begrenzt.'},
  {id:'h68',cat:'FeuAK · VWL',q:'Ein ausländischer Hersteller bietet HLF 20 deutlich günstiger auf dem deutschen Markt an. Welche Markteffekte entstehen?',a:'<strong>Angebotsseite:</strong> Neuer Anbieter → Gesamtangebotskurve verschiebt sich nach <strong>rechts</strong>.<br><strong>Neues Gleichgewicht:</strong> Gleichgewichtspreis sinkt, Gleichgewichtsmenge steigt → Kommunen profitieren.<br><strong>Heimische Hersteller:</strong> Wettbewerbsdruck → Margendruck, ggf. Marktaustritt schwacher Anbieter.<br><strong>Qualitätsfrage:</strong> Normenkonformität DIN EN 1846, CE-Zulassung müssen erfüllt sein.<br><strong>Strategische Abhängigkeit:</strong> Risiko bei Konzentration auf einen ausländischen Lieferanten (Lieferzeiten, Versorgungssicherheit).<br><strong>Politische Reaktion:</strong> EU-Antidumping-Maßnahmen möglich.'},
