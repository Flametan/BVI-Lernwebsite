...
const FALLBEARBEITUNG = (function(){
  ...
  const CASES = [
    ...
    ,
    {
      ...
      answers:[
        'Ermächtigungsgrundlage: §34 Abs.1 BHKG (Hilfeleistung bei technischen Notlagen) i.V.m. §44 Abs.2 BHKG (Betreten von Grundstücken, Absperrmaßnahmen). Die Absperrung des Gefahrenbereichs ist ein <strong>Realakt</strong> (kein Adressat vor Ort, dem eine Anordnung erteilt werden könnte). Soweit Umstehende zum Verlassen des Gefahrenbereichs aufgefordert werden, liegt ein <strong>Verwaltungsakt</strong> gem. §35 VwVfG vor.',
        'Sachlich: §1 Abs.1 i.V.m. §3 Abs.1 S.1 BHKG (technische Hilfeleistung). Örtlich: §3 Abs.1 S.1 BHKG (Gemeindegebiet). Instanziell: §3 Abs.1 S.1 BHKG (Feuerwehr). Anhörungsverzicht für Personenanordnungen: §28 Abs.2 Nr.1 VwVfG (Einsturzgefahr = Gefahr im Verzug). Bei Realakt entfällt Anhörung von vornherein.',
        ...
        'Kein Adressat für die Kernaßnahme (leere Halle) → Realakt. <strong>Verhaltensstörer:</strong> Betonmischer-Fahrer/Firma (hat den Balken beschädigt und damit die Gefahr kausal verursacht). <strong>Zustandsstörer:</strong> Eigentümer der Halle (von seiner Sache geht die Einsturzgefahr aus). Für Kostenersatz und Weiterleitungspflichten relevant; als Adressat einer Ordnungsverfügung der Bauaufsichtsbehörde.',
        ...
        '<strong>Kostenersatz:</strong> §48 BHKG gegenüber Verhaltensstörer (Betonmischer-Firma) bei Vorsatz oder grober Fahrlässigkeit; gegenüber Zustandsstörer (Halleneigentümer) für Feuerwehreinsatz. <strong>Amtshaftung</strong> (§839 BGB i.V.m. Art. 34 GG) scheidet aus – die Absperrmaßnahme war rechtmäßig. Da die Feuerwehr keine Dritten als Nichtstörer in Anspruch genommen hat, ist §45 BHKG nicht einschlägig.'
      ]
    },
    {
      id:6,
      ...
      answers:[
        ...
        'Sachlich: §1 Abs.1 i.V.m. §3 Abs.1 S.1 BHKG (Brandbekämpfung). Örtlich: §3 Abs.1 S.1 BHKG. Instanziell: §3 Abs.1 S.1 BHKG. Anhörungsverzicht: §28 Abs.2 Nr.1 VwVfG (Schornsteinbrand mit Ausbreitungsgefahr = Gefahr im Verzug). Mündlicher VA gem. §37 Abs.2 VwVfG; Bekanntgabe gem. §41 Abs.1 VwVfG. Bei Realakt (Nachbarwohnung) entfällt Anhörung von vornherein.',
        ...
        'c) <strong>Beim Verlassen:</strong> Geöffnete Wohnungen sichern und wieder verschließen (Provisorium). Bewohner der Nachbarwohnung und Vermieter/Eigentümer umgehend benachrichtigen. Vorgang vollständig dokumentieren (Einsatzbericht: Rechtsgrundlage, Maßnahmen, Zeitpunkte, Gründe). Sicherstellen, dass keine Glutnester zurückbleiben. <strong>Kosten/Schadensersatz:</strong> Der Mieter ist kein Störer → §48 BHKG nicht einschlägig. Schäden an der Tür können als Aufopferungsanspruch geltend gemacht werden, sofern die Maßnahme besonders schwerwiegend war. Amtshaftung scheidet aus (rechtmäßige Maßnahme).'
      ]
    }
  ];
