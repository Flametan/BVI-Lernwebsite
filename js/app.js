...
const PROGRESS = (function(){
  const GROUPS = {
    ...
    vak:  ['v-vak-lernzusammenfassung','v-vak-jur-denken','v-vak-verwaltungsrecht','v-vak-staatsrecht','v-vak-einsatzrecht','v-vak-dienstrecht','v-vak-altklausur','v-vak-klausurhinweise','v-vak-klausurfaelle'],
...
const SEARCH = (function(){
  ...
  const VIEW_LABELS = {
    ...
    'v-vak-klausurhinweise':'VAk · Klausurhinweise','v-vak-klausurfaelle':'VAk · Klausurfälle',
...
const QUIZ=(function(){
  ...
  const Q=[
    ...
    {id:68,cat:'Allgemeines Verwaltungsrecht',type:'mc',q:'Was regelt das Entschließungsermessen einer Behörde?',opts:['Das „Ob" des behördlichen Handelns – ob die Behörde tätig wird','Das „Wie" – die Art und Weise der Maßnahme','Die Auswahl zwischen mehreren Adressaten','Den Zeitpunkt des behördlichen Eingreifens'],correct:0,exp:'Das Entschließungsermessen (§ 40 VwVfG) betrifft das „Ob" – ob die Behörde bei Vorliegen aller Voraussetzungen tätig wird oder untätig bleibt. Das „Wie" regelt das Auswahlermessen.'},
    {id:69,cat:'Allgemeines Verwaltungsrecht',type:'mc',q:'Was regelt das Auswahlermessen einer Behörde?',opts:['Das „Ob" des behördlichen Handelns','Das „Wie" – die Auswahl der passenden Maßnahme oder Person','Die Zuständigkeit der Behörde','Ob überhaupt ein Verwaltungsakt erlassen werden darf'],correct:1,exp:'Das Auswahlermessen (§ 40 VwVfG) betrifft das „Wie" – bei mehreren erlaubten Maßnahmen oder Adressaten wählt die Behörde die passende Reaktion aus.'},
    {id:70,cat:'Allgemeines Verwaltungsrecht',type:'mc',q:'Was versteht man unter einer Ermessensreduzierung auf Null?',opts:['Die Behörde hat kein Ermessen und muss untätig bleiben','Aufgrund besonderer Umstände ist nur noch eine einzige rechtmäßige Entscheidung möglich','Die Behörde kann frei zwischen allen Maßnahmen wählen','Das Ermessen wird auf eine übergeordnete Behörde übertragen'],correct:1,exp:'Bei der Ermessensreduzierung auf Null schrumpft der gesetzliche Spielraum der Behörde so stark, dass nur noch eine rechtmäßige Entscheidung verbleibt. Jede andere Handlung wäre rechtswidrig (gebundene Entscheidung).'},
