...
const EINGRENZUNG_QUIZ = (function(){
  ...
  const QUESTIONS = [
    ...
    {id:10,nr:'Frage 10',punkte:5,cat:'Vergabe',
     text:'Nennen Sie die 8 Grundsätze des Vergaberechts (§97 GWB) und geben Sie zu jedem Grundsatz die wesentlichen Stichpunkte an.',
     answer:'Die Grundsätze des Vergaberechts (§97 GWB) durchziehen als <strong>‚rote Fäden‘</strong> das gesamte Vergaberecht. Übergeordnetes Ziel: <strong>wirtschaftlichstes Angebot</strong> (MEAT) = bestes Preis-Leistungs-Verhältnis (§127 GWB).<br><br>1. <strong>Wettbewerbsgrundsatz:</strong> Primär öffentliche Ausschreibung · genaue und bestimmte Festlegung der Zuschlagskriterien → kein willkürlicher Zuschlag möglich<br><br>2. <strong>Transparenzgebot:</strong> Veröffentlichungspflichten in Auftragsbekanntmachung oder Vergabeunterlagen · Bieterkommunikation §7 Abs. 2 VgV · primär öffentliche Ausschreibung<br><br>3. <strong>Gleichbehandlung (§97 Abs. 2 GWB):</strong> Alle Teilnehmer gleich behandeln – Ungleichbehandlung nur gesetzlich geboten oder gestattet · einheitliche Bieterkommunikation<br><br>4. <strong>Verhältnismäßigkeit:</strong> Eignungs- und Zuschlagskriterien in angemessenem Verhältnis zum Auftragsgegenstand (§122, §127 GWB) · angemessene Fristsetzung (§20 VgV) · fakultativer Ausschluss nur unter Berücksichtigung der Verhältnismäßigkeit (§124 Abs. 1 GWB)<br><br>5. <strong>Gebot der Mittelstandsfreundlichkeit:</strong> Grundsätzlich Losaufteilung – Teils- und Fachlose (§97 Abs. 4 GWB) · FW: Los 1 Fahrgestell · Los 2 FW-Aufbau · Los 3 Beladung<br><br>6. <strong>Berücksichtigung strategischer Ziele:</strong> Nachhaltigkeitsaspekte · Innovationsfreundlichkeit · Mindestlohn &amp; sozialverträgliche Beschaffung<br><br>7. <strong>Gebot des Einsatzes elektronischer Mittel:</strong> E-Vergabe ab Oberschwelle Pflicht; perspektivisch Digitaler Marktplatz Deutschland (bis 31.12.2027)<br><br>8. <strong>Rechtsanspruch auf Einhaltung der Vergaberegeln:</strong> Bieter können Verstöße rügen (§160 GWB); Nachprüfungsverfahren vor der Vergabekammer'},
  ];
